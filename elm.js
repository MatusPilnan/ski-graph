...
{
	if (region.bS.bf === region.bv.bf)
	{
		return 'on line ' + region.bS.bf;
	}
	return 'on lines ' + region.bS.bf + ' through ' + region.bv.bf;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d3: 'hidden', dN: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d3: 'mozHidden', dN: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d3: 'msHidden', dN: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d3: 'webkitHidden', dN: 'webkitvisibilitychange' }
		: { d3: 'hidden', dN: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.ei, request.dv, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cJ: fragment, cM: host, eu: path, c1: port_, c4: protocol, c5: query};
	});
...
var $author$project$Geometry$Point = F2(
	function (x, y) {
		return {f: x, g: y};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{dB: false, dK: r.dK, cH: r.cH, cL: r.cL, ei: r.ei, eQ: r.eQ, ds: r.ds, dv: r.dv}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{dK: $elm$http$Http$emptyBody, cH: r.cH, cL: _List_Nil, ei: 'GET', eQ: $elm$core$Maybe$Nothing, ds: $elm$core$Maybe$Nothing, dv: r.dv});
};
...
var $author$project$Graph$GraphIndexEntry = F4(
	function (title, path, id, location) {
		return {r: id, ec: location, eu: path, a2: title};
	});
var $elm$json$Json$Decode$fail = _Json_fail;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Saves$graphIndexEntryLocationDecoder = A2(
	...
	function (loc) {
		switch (loc) {
			...
			default:
				var other = loc;
				return $elm$json$Json$Decode$fail('Unrecognized location type: ' + other);
		}
	},
	$elm$json$Json$Decode$string);
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Saves$graphIndexEntryDecoder = function (location) {
	if (!location.$) {
		var loc = location.a;
		return A4(
			$elm$json$Json$Decode$map3,
			F3(
				function (title, path, id) {
					return A4($author$project$Graph$GraphIndexEntry, title, path, id, loc);
				}),
		...
		return A5(
			...
			F4(
				function (title, path, id, loc) {
					return A4($author$project$Graph$GraphIndexEntry, title, path, id, loc);
				}),
			A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'location', $author$project$Saves$graphIndexEntryLocationDecoder));
	}
};
	...
	return A2(
		...
		$elm$json$Json$Decode$list(
			A2(
				$elm$json$Json$Decode$map,
				function (entry) {
					return _Utils_Tuple2(entry.r, entry);
				},
				$author$project$Saves$graphIndexEntryDecoder(
					$elm$core$Maybe$Just(location)))));
};
var $author$project$Messages$LoadGraphIndex = function (a) {
	return {$: 16, a: a};
};
var $author$project$Requests$graphIndexHandler = function (response) {
	if (!response.$) {
		var index = response.a;
		return $author$project$Messages$LoadGraphIndex(
			$elm$core$Maybe$Just(
				$elm$core$Result$Ok(index)));
	} else {
		return $author$project$Messages$LoadGraphIndex(
			$elm$core$Maybe$Just(
				$elm$core$Result$Err('Failed to load remote graph index.')));
	}
};
...
var $author$project$Menus$Menus$Default = {$: 0};
var $author$project$Menus$Menus$init = {dI: 1, cB: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, d4: $elm$core$Dict$empty, d5: $elm$core$Dict$empty, bF: $author$project$Menus$Menus$Default, eH: false};
...
var $author$project$Graph$LiftStation = {$: 0};
var $author$project$Graph$SkiRunFork = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Graph$skiRunTypeToString = function (skiRunType) {
	switch (skiRunType) {
		case 0:
			return 'easy';
		case 1:
...
var $author$project$Graph$calculateForkPercentages = function (types) {
	var skiRunTypes = A2(
		$elm$core$List$filterMap,
		function (edgeType) {
			if (!edgeType.$) {
				var skiRunType = edgeType.a;
				return $elm$core$Maybe$Just(skiRunType);
			} else {
				return $elm$core$Maybe$Nothing;
			}
		},
		types);
	var total = $elm$core$List$length(skiRunTypes);
	return A3(
		$elm$core$List$foldl,
		F2(
			function (skiRunType, percentages) {
				return A3(
					$elm$core$Dict$update,
					$author$project$Graph$skiRunTypeToString(skiRunType),
					function (count) {
						return $elm$core$Maybe$Just(
							A2(
								$elm$core$Maybe$withDefault,
...
var $author$project$Graph$selectVertexType = F2(
	function (vertex, edgeTypes) {
		var percentages = $author$project$Graph$calculateForkPercentages(edgeTypes);
		return A2(
			$elm$core$List$any,
			function (et) {
				if (!et.$) {
			...
			edgeTypes) ? _Utils_update(
			vertex,
			{cj: $author$project$Graph$LiftStation}) : _Utils_update(
			vertex,
			{
				cj: $author$project$Graph$SkiRunFork(percentages)
			});
	});
...
var $author$project$Graph$calculateVertexTypes = function (graph) {
	var update = F2(
		function (edge, types) {
			if (types.$ === 1) {
				return $elm$core$Maybe$Just(
	...
	var vertexEdgeTypes = A3(
		$elm$core$List$foldl,
		F2(
			function (edge, edgeTypes) {
				return function () {
					var _v2 = edge.bv;
					if (!_v2.$) {
						var v = _v2.a;
	...
	return _Utils_update(
		graph,
		{
			H: A6(
				...
				F4(
					function (vertexId, edgeTypes, vertex, vertices) {
						return A3(
							$elm$core$Dict$insert,
							vertexId,
							A2($author$project$Graph$selectVertexType, vertex, edgeTypes),
							vertices);
					}),
				F3(
					function (vertexId, vertex, vertices) {
						return A3($elm$core$Dict$insert, vertexId, vertex, vertices);
					}),
				vertexEdgeTypes,
				graph.H,
				$elm$core$Dict$empty)
...
var $author$project$Graph$getNextEdgeId = function (graph) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		A2(
			...
			$elm$core$List$maximum(
				$elm$core$Dict$keys(graph.E))));
};
var $author$project$Graph$getNextVertexId = function (graph) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		A2(
			...
			$elm$core$List$maximum(
				$elm$core$Dict$keys(graph.H))));
};
var $author$project$Graph$Graph = F7(
	function (title, id, background, vertices, edges, backgroundPosition, zoom) {
		return {bX: background, bZ: backgroundPosition, E: edges, r: id, a2: title, H: vertices, cm: zoom};
	});
var $author$project$Graph$Edge = F8(
	function (id, title, start, end, edgeType, boundBoxTopLeft, boundBoxBottomRight, points) {
		return {dL: boundBoxBottomRight, dM: boundBoxTopLeft, b1: edgeType, bv: end, r: id, ew: points, bS: start, a2: title};
	});
...
var $author$project$Geometry$findExtremePoints = function (points) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (point, extremes) {
				if (extremes.$ === 1) {
					return $elm$core$Maybe$Just(
					...
					var _v1 = extremes.a;
					var topLeft = _v1.a;
					var bottomRight = _v1.b;
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							A2(
								$author$project$Geometry$Point,
								A2($elm$core$Basics$min, topLeft.f, point.f),
								A2($elm$core$Basics$max, topLeft.g, point.g)),
							A2(
								$author$project$Geometry$Point,
								A2($elm$core$Basics$max, bottomRight.f, point.f),
								A2($elm$core$Basics$min, bottomRight.g, point.g))));
				}
			}),
		$elm$core$Maybe$Nothing,
		points);
...
var $author$project$GraphUtils$calculateEdgeBoundingBox = function (edge) {
	var _v0 = A2(
		$elm$core$Maybe$withDefault,
		_Utils_Tuple2(edge.bS.ex, edge.bS.ex),
		$author$project$Geometry$findExtremePoints(
			_Utils_ap(
				edge.ew,
				_Utils_ap(
					_List_fromArray(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								edge.bv)))))));
	var topLeft = _v0.a;
	var bottomRight = _v0.b;
	return _Utils_update(
		edge,
		{dL: bottomRight, dM: topLeft});
};
var $author$project$Graph$Difficult = 2;
var $author$project$Graph$Easy = 0;
var $author$project$Graph$Medium = 1;
var $author$project$Graph$SkiRoute = 3;
var $author$project$Graph$SkiRun = function (a) {
	return {$: 0, a: a};
};
var $author$project$Graph$Unfinished = {$: 2};
		...
		switch (edgeType) {
			case 'skirun.easy':
				return $elm$json$Json$Decode$succeed(
					$author$project$Graph$SkiRun(0));
			case 'skirun.medium':
				return $elm$json$Json$Decode$succeed(
					$author$project$Graph$SkiRun(1));
			case 'skirun.difficult':
				return $elm$json$Json$Decode$succeed(
					$author$project$Graph$SkiRun(2));
			case 'skirun.ski-route':
				return $elm$json$Json$Decode$succeed(
					$author$project$Graph$SkiRun(3));
			case 'lift':
				return $elm$json$Json$Decode$succeed($author$project$Graph$Lift);
			case 'unfinished':
				return $elm$json$Json$Decode$succeed($author$project$Graph$Unfinished);
			default:
				var v = edgeType;
	...
	function (coordinates) {
		if (coordinates.b) {
			if (coordinates.b.b) {
				...
				var y = _v1.a;
				return $elm$json$Json$Decode$succeed(
					A2($author$project$Geometry$Point, x, y));
			} else {
...
var $author$project$Graph$Vertex = F4(
	function (id, title, vertexType, position) {
		return {r: id, ex: position, a2: title, cj: vertexType};
	});
var $author$project$Saves$vertexDecoder = A4(
	$elm$json$Json$Decode$map3,
	F3(
		function (id, title, position) {
			return A4($author$project$Graph$Vertex, id, title, $author$project$Graph$LiftStation, position);
		}),
					...
					A3(
						...
						F2(
							function (start, _v1) {
								...
								return _Utils_Tuple2(
									id,
									$author$project$GraphUtils$calculateEdgeBoundingBox(
										A8(
...
var $author$project$Saves$graphDecoder = A7(
	$elm$json$Json$Decode$map6,
	F6(
		function (title, zoom, background, position, id, _v0) {
			var vertices = _v0.a;
			var edges = _v0.b;
			return A7($author$project$Graph$Graph, title, id, background, vertices, edges, position, zoom);
		}),
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
...
var $author$project$Saves$loadGraphFromJsonToModel = F2(
	function (jsonString, model) {
		if (jsonString.$ === 1) {
			...
			var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$Saves$graphDecoder, json);
			if (!_v1.$) {
				var graph = _v1.a;
				return _Utils_update(
					model,
					{
						...
						q: $author$project$Graph$getNextEdgeId(graph),
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		A2(
			...
			flags.cK,
			{
				aj: $author$project$Graph$Lift,
				v: {
					ba: $mdgriffith$elm_animator$Animator$init(0),
					P: $mdgriffith$elm_animator$Animator$init($elm$core$Maybe$Nothing),
					bz: $mdgriffith$elm_animator$Animator$init(0),
					bA: $mdgriffith$elm_animator$Animator$init(0)
				},
				a8: flags.a8,
				...
				by: false,
				b4: flags.b4,
				ao: A2($author$project$Saves$graphIndexFromJson, 0, flags.ao),
				J: flags.dc,
				R: 1,
				aT: false,
				eh: $author$project$Menus$Menus$init,
				aU: false,
				cX: A2($author$project$Geometry$Point, 0, 0),
				ae: A2($author$project$Geometry$Point, 0, 0),
		...
		$author$project$Requests$fetchGraphIndex(flags.a8));
};
...
var $mdgriffith$elm_animator$Internal$Timeline$applyQueued = function (timeline) {
	...
	if (_v0.$ === 1) {
		...
		return _Utils_update(
			timeline,
			{
				cG: A3($mdgriffith$elm_animator$Internal$Timeline$enqueue, timeline, timeline.cZ, queued),
				bi: $elm$core$Maybe$Nothing
			});
	}
};
...
var $mdgriffith$elm_animator$Internal$Timeline$clean = F2(
	function (runGC, details) {
		...
		return _Utils_update(
			details,
			{
				cG: runGC ? A3($mdgriffith$elm_animator$Internal$Timeline$garbageCollectOldEvents, details.cZ, _List_Nil, events) : details.cG,
				bP: running
			});
	});
...
var $mdgriffith$elm_animator$Internal$Timeline$updateWith = F3(
	function (withGC, possiblyNow, _v0) {
		...
		var now = A2(
			...
			timeline.cZ);
		return _Utils_eq(timeline.cG, _List_Nil) ? A2(
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {b9: oldTime, c9: request, dn: subs};
	});
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_animator$Animator$toSubscription, $author$project$Messages$AnimationFrame, model.v, $author$project$Main$animator)
			]));
};
...
var $joakin$elm_canvas$Canvas$Texture$dimensions = function (texture) {
	if (!texture.$) {
		var image = texture.a;
		return {b4: image.b4, cl: image.cl};
	} else {
		var data = texture.a;
		return {b4: data.b4, cl: data.cl};
	}
};
var $author$project$Graph$getProperty = F3(
	function (property, _default, graph) {
		return A2(
			$elm$core$Maybe$withDefault,
			_default,
			A2($elm$core$Maybe$map, property, graph));
	});
var $author$project$Graph$getZoom = function (graph) {
	return A3(
...
var $author$project$GraphUtils$constrainBackgroundToCanvas = F2(
	function (model, _new) {
		var w = A2(
			$elm$core$Maybe$withDefault,
			model.cl,
			A2(
				$elm$core$Maybe$map,
				function (t) {
					return $joakin$elm_canvas$Canvas$Texture$dimensions(t).cl;
				},
				model.dq));
		var h = A2(
			$elm$core$Maybe$withDefault,
			...
			A2(
				$elm$core$Maybe$map,
				function (t) {
					return $joakin$elm_canvas$Canvas$Texture$dimensions(t).b4;
				},
				model.dq));
		return A2(
			$author$project$Geometry$Point,
			A2(
				...
				A2(
					$elm$core$Basics$max,
					(0 - (w * $author$project$Graph$getZoom(model.cC))) + model.cl,
					_new.f)),
			A2(
				$elm$core$Basics$min,
				0,
				A2(
					$elm$core$Basics$max,
					(0 - (h * $author$project$Graph$getZoom(model.cC))) + model.b4,
					_new.g)));
	});
var $author$project$Graph$zeroPoint = A2($author$project$Geometry$Point, 0, 0);
var $author$project$Graph$getPosition = function (graph) {
	return A3(
		$author$project$Graph$getProperty,
		function ($) {
			return $.bZ;
...
var $author$project$Main$adaptToNewDimensions = F3(
	function (width, height, _v0) {
		...
		var zoomAfter = A2(
			$elm$core$Basics$max,
			$author$project$Graph$getZoom(model.cC),
					...
					cC: A2(
						...
						A2(
							...
							$author$project$Graph$setPosition(
								A2(
									$author$project$GraphUtils$constrainBackgroundToCanvas,
									newModel,
									$author$project$Graph$getPosition(model.cC))),
							$author$project$Graph$setZoom(zoomAfter)),
						model.cC)
				}),
			cmd);
	});
var $author$project$Graph$addEdge = F2(
	function (edge, graph) {
		return _Utils_update(
			graph,
			{
				E: A3($elm$core$Dict$insert, edge.r, edge, graph.E)
			});
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Geometry$mulPoint = F2(
	function (point, coef) {
		return _Utils_update(
			point,
			{f: point.f * coef, g: point.g * coef});
	});
var $author$project$Geometry$subPoints = F2(
	function (a, b) {
		return _Utils_update(
			a,
			{f: a.f - b.f, g: a.g - b.g});
	});
var $author$project$Geometry$canvasPointToBackgroundPoint = F3(
	function (canvasPoint, backgroundPosition, zoomLevel) {
		return A2(
			$author$project$Geometry$mulPoint,
			A2($author$project$Geometry$subPoints, canvasPoint, backgroundPosition),
			1 / zoomLevel);
	});
...
var $author$project$Graph$getEdges = function (graph) {
	return A3(
		$author$project$Graph$getProperty,
		function ($) {
			return $.E;
...
var $author$project$Graph$getEdgesList = function (graph) {
	return $elm$core$Dict$values(
		$author$project$Graph$getEdges(graph));
};
var $author$project$Geometry$isPointInRect = F3(
	function (point, topLeft, bottomRight) {
		return ((_Utils_cmp(topLeft.f, point.f) < 0) && (_Utils_cmp(point.f, bottomRight.f) < 0)) && ((_Utils_cmp(bottomRight.g, point.g) < 0) && (_Utils_cmp(point.g, topLeft.g) < 0));
	});
var $author$project$Geometry$addPoints = F2(
	function (a, b) {
		return _Utils_update(
			a,
			{f: a.f + b.f, g: a.g + b.g});
	});
var $author$project$Geometry$normalVector = function (line) {
	return A2($author$project$Geometry$Point, line.av, line.az);
};
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$Geometry$closestPointOnLine = F2(
	function (line, point) {
		var n = (((-(line.av * point.f)) - (line.az * point.g)) - line.b_) / (A2($elm$core$Basics$pow, line.av, 2) + A2($elm$core$Basics$pow, line.az, 2));
		return A2(
			$author$project$Geometry$addPoints,
			point,
			A2(
				$author$project$Geometry$mulPoint,
				$author$project$Geometry$normalVector(line),
				n));
	});
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $author$project$Geometry$pointToLength = function (point) {
	return $elm$core$Basics$sqrt(
		A2($elm$core$Basics$pow, point.f, 2) + A2($elm$core$Basics$pow, point.g, 2));
};
var $author$project$Geometry$pointToLineDistance = F2(
	function (line, point) {
		return $elm$core$Basics$abs(((line.av * point.f) + (line.az * point.g)) + line.b_) / $author$project$Geometry$pointToLength(
			A2($author$project$Geometry$Point, line.av, line.az));
	});
var $author$project$Geometry$isPointOnLine = F3(
	function (line, threshold, point) {
		return (_Utils_cmp(
			A2($author$project$Geometry$pointToLineDistance, line, point),
			threshold) < 1) ? $elm$core$Maybe$Just(
			A2($author$project$Geometry$closestPointOnLine, line, point)) : $elm$core$Maybe$Nothing;
	});
var $author$project$Geometry$Line = F3(
	function (a, b, c) {
		return {av: a, az: b, b_: c};
	});
var $author$project$Geometry$lineFromPoints = F2(
	function (one, other) {
		var directionVector = A2($author$project$Geometry$subPoints, one, other);
		var b = directionVector.f;
		var a = -directionVector.g;
		var c = -((a * one.f) + (b * one.g));
		return A3($author$project$Geometry$Line, a, b, c);
	});
var $author$project$Geometry$lineWidth = 5;
var $author$project$GraphUtils$pointOverEdge = F3(
	function (target, zoom, edge) {
		return A3($author$project$Geometry$isPointInRect, target, edge.dM, edge.dL) ? $elm$core$List$head(
			A2(
				$elm$core$List$filterMap,
				function (_v2) {
					var segmentStart = _v2.a;
					var segmentEnd = _v2.b;
					return A3(
						$author$project$Geometry$isPointOnLine,
						A2($author$project$Geometry$lineFromPoints, segmentStart, segmentEnd),
						$author$project$Geometry$lineWidth / zoom,
						target);
				},
				A3(
					$elm$core$List$foldl,
					F2(
						function (point, _v0) {
							...
							var bottomRight = _v1.b;
							return _Utils_Tuple2(
								A3($author$project$Geometry$isPointInRect, target, topLeft, bottomRight) ? _Utils_ap(
									result,
									_List_fromArray(
										[
											_Utils_Tuple2(previousPoint, point)
										])) : result,
								point);
						}),
					_Utils_Tuple2(_List_Nil, edge.bS.ex),
					_Utils_ap(
						edge.ew,
						A2(
							$elm$core$Maybe$withDefault,
							...
							A2(
								...
								A2(
									...
									edge.bv))))).a)) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$getEdgeOnPositionFromGraph = F2(
	function (graph, position) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (edge) {
					return $author$project$Utils$maybeHasValue(
						A3($author$project$GraphUtils$pointOverEdge, position, graph.cm, edge));
				},
				$author$project$Graph$getEdgesList(
					$elm$core$Maybe$Just(graph))));
	});
var $author$project$GraphUtils$splitEdgeSegments = F3(
			...
			A3(
				...
				F2(
					function (point, _v0) {
						...
						var previousPoint = _v0.b;
						var found = _v0.c;
						return (found || $author$project$Utils$maybeHasValue(
							A3(
								$author$project$Geometry$isPointOnLine,
								A2($author$project$Geometry$lineFromPoints, previousPoint, point),
								$author$project$Geometry$lineWidth / zoom,
								splitPoint))) ? _Utils_Tuple3(
							_Utils_Tuple2(
								before,
								_Utils_ap(
									after,
...
var $author$project$GraphUtils$splitEdge = F5(
	function (edge, point, newEdgeId, newVertexId, graph) {
		var newVertex = A4(
			$author$project$Graph$Vertex,
			newVertexId,
			$elm$core$Maybe$Nothing,
			$author$project$Graph$SkiRunFork(
				$author$project$Graph$calculateForkPercentages(
					_List_fromArray(
						[edge.b1, edge.b1]))),
			point);
		var _v0 = A3($author$project$GraphUtils$splitEdgeSegments, edge, point, graph.cm);
		var pointsBeforeSplit = _v0.a;
		var pointsAfterSplit = _v0.b;
		return _Utils_update(
			graph,
			{
				E: A3(
					...
					$author$project$GraphUtils$calculateEdgeBoundingBox(
						_Utils_update(
							edge,
							{r: newEdgeId, ew: pointsAfterSplit, bS: newVertex})),
					A3(
						$elm$core$Dict$insert,
						edge.r,
						$author$project$GraphUtils$calculateEdgeBoundingBox(
							_Utils_update(
								edge,
								{
									bv: $elm$core$Maybe$Just(newVertex),
									ew: pointsBeforeSplit
								})),
						graph.E)),
				H: A3($elm$core$Dict$insert, newVertex.r, newVertex, graph.H)
			});
	});
var $author$project$Graph$updateGraphProperty = F3(
	function (func, _new, graph) {
		return A2(
			$elm$core$Maybe$map,
			func(_new),
			graph);
	});
var $author$project$Main$connectEdgeToEdge = F4(
	function (model, edge, targetEdge, point) {
		return _Utils_eq(point, edge.bS.ex) ? model : _Utils_update(
			model,
			{
				cC: A3(
					...
					F2(
						function (newEdge, graph) {
							return $author$project$Graph$calculateVertexTypes(
								function (updatedGraph) {
									var decision = _Utils_Tuple2(
										_Utils_eq(newEdge.bS.r, -1),
										A2($author$project$Main$getEdgeOnPositionFromGraph, updatedGraph, newEdge.bS.ex));
									var action = F2(
														...
														newEdge,
														{
															bS: function () {
																...
																return _Utils_update(
																	s,
																	{
																		r: _Utils_eq(s.r, -1) ? (model.l + 1) : s.r
																	});
															}()
														})),
												A5($author$project$GraphUtils$splitEdge, splitEdge, splitPoint, model.q + 3, model.l + 1, updatedGraph));
										});
									if (decision.a && (!decision.b.$)) {
										var splitEdge = decision.b.a;
										return A2(action, splitEdge, newEdge.bS.ex);
									} else {
										return updatedGraph;
									}
								}(
									A5(
										$author$project$GraphUtils$splitEdge,
										targetEdge,
										point,
										model.q + 2,
										model.l,
										A2(
											$author$project$Graph$addEdge,
											$author$project$GraphUtils$calculateEdgeBoundingBox(newEdge),
											graph))));
						}),
					_Utils_update(
						edge,
						{
							...
							bv: $elm$core$Maybe$Just(
								A4($author$project$Graph$Vertex, model.l, $elm$core$Maybe$Nothing, $author$project$Graph$LiftStation, point))
						}),
					model.cC),
				t: $elm$core$Maybe$Nothing,
				q: _Utils_eq(edge.bS.r, -1) ? (model.q + 3) : (model.q + 2),
				l: _Utils_eq(edge.bS.r, -1) ? (model.l + 2) : (model.l + 1)
			});
	});
var $author$project$Main$getEdgeOnPosition = F2(
			...
			A2(
				...
				function (edge) {
					return A2(
						$elm$core$Maybe$map,
						function (point) {
							return _Utils_Tuple2(edge, point);
						},
						A3(
							$author$project$GraphUtils$pointOverEdge,
							position,
							$author$project$Graph$getZoom(model.cC),
							edge));
				},
				$author$project$Graph$getEdgesList(model.cC)));
	});
var $author$project$Main$connectEdgeToVertex = F3(
	function (model, edge, vertex) {
		return _Utils_update(
			model,
			{
				cC: A3(
							...
							_Utils_eq(newEdge.bS.r, -1) ? A4(
								...
								A2(
									...
									A2(
										...
										A2($author$project$Main$getEdgeOnPosition, model, newEdge.bS.ex))),
								newEdge.bS.ex,
								model.q + 2,
											...
											newEdge,
											{
												bS: function () {
													...
													return _Utils_update(
														s,
														{
															r: _Utils_eq(s.r, -1) ? model.l : s.r
														});
												}()
											}))),
								$author$project$Graph$calculateVertexTypes));
					},
					$author$project$GraphUtils$calculateEdgeBoundingBox(
						_Utils_update(
							edge,
							{
								b1: model.aj,
								bv: $elm$core$Maybe$Just(vertex)
							})),
					model.cC),
				t: $elm$core$Maybe$Nothing,
				q: _Utils_eq(edge.bS.r, -1) ? (model.q + 2) : (model.q + 1),
				l: _Utils_eq(edge.bS.r, -1) ? (model.l + 1) : model.l
			});
	});
var $author$project$GraphUtils$mouseOverEdge = F4(
	function (backgroundPosition, zoom, mousePosition, edge) {
		...
		return A3($author$project$GraphUtils$pointOverEdge, mousePos, zoom, edge);
	});
			...
			A2(
				...
				function (edge) {
					return A2(
						...
						A4(
							$author$project$GraphUtils$mouseOverEdge,
							$author$project$Graph$getPosition(model.cC),
							$author$project$Graph$getZoom(model.cC),
							event.ex,
							edge));
...
var $author$project$Graph$getVertices = function (graph) {
	return A3(
		$author$project$Graph$getProperty,
		function ($) {
			return $.H;
...
var $author$project$Graph$getVerticesList = function (graph) {
	return $elm$core$Dict$values(
		$author$project$Graph$getVertices(graph));
};
var $author$project$Geometry$backgroundPointToCanvasPoint = F3(
	function (backgroundPoint, backgroundPosition, zoomLevel) {
		return A2(
			$author$project$Geometry$addPoints,
			backgroundPosition,
			A2($author$project$Geometry$mulPoint, backgroundPoint, zoomLevel));
	});
var $author$project$Geometry$liftStationPointSize = 10;
var $author$project$Geometry$mouseOverPoint = F4(
	function (backgroundPosition, zoomLevel, mousePosition, point) {
		var a = A3($author$project$Geometry$backgroundPointToCanvasPoint, point, backgroundPosition, zoomLevel);
		return _Utils_cmp(
			$author$project$Geometry$liftStationPointSize,
			$author$project$Geometry$pointToLength(
				A2($author$project$Geometry$subPoints, a, mousePosition))) > -1;
	});
var $author$project$Main$getVertexOnPosition = F2(
	function (model, position) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (v) {
					return A4(
						$author$project$Geometry$mouseOverPoint,
						$author$project$Graph$getPosition(model.cC),
						$author$project$Graph$getZoom(model.cC),
						position,
						v.ex);
				},
				$author$project$Graph$getVerticesList(model.cC)));
	});
var $author$project$Main$getHoveringVertex = F2(
	function (model, event) {
		return A2($author$project$Main$getVertexOnPosition, model, event.ex);
	});
...
var $author$project$Main$checkConnectDrawing = F2(
	function (event, _v0) {
		...
		return _Utils_Tuple2(
			function () {
				var _v1 = _Utils_Tuple3(event.aC, maybeVertex, model.t);
				_v1$2:
				while (true) {
					if (!_v1.a) {
						if (!_v1.b.$) {
							if (!_v1.c.$) {
								...
								var vertex = _v1.b.a;
								var edge = _v1.c.a;
								return (!_Utils_eq(vertex, edge.bS)) ? A3($author$project$Main$connectEdgeToVertex, model, edge, vertex) : model;
							} else {
								break _v1$2;
							}
						} else {
							if (!_v1.c.$) {
								...
								var _v4 = _v1.b;
								var edge = _v1.c.a;
								var _v5 = A2($author$project$Main$getHoveringEdge, model, event);
								if (_v5.$ === 1) {
									return _Utils_update(
										model,
										{
													...
													edge,
													{
														ew: _Utils_ap(
															...
															_List_fromArray(
																[
																	A3(
																	$author$project$Geometry$canvasPointToBackgroundPoint,
																	event.ex,
																	$author$project$Graph$getPosition(model.cC),
																	$author$project$Graph$getZoom(model.cC))
																]))
									...
									var _v6 = _v5.a;
									var targetEdge = _v6.a;
									var point = _v6.b;
									return A4($author$project$Main$connectEdgeToEdge, model, edge, targetEdge, point);
								}
							} else {
								break _v1$2;
							}
...
var $author$project$Main$checkDrawing = F2(
	function (event, _v0) {
		...
		return _Utils_Tuple2(
			function () {
				var _v1 = _Utils_Tuple3(event.aC, model.aU, model.t);
...
var $author$project$Main$checkModelDragging = F2(
	function (event, _v0) {
		var model = _v0.a;
		var cmd = _v0.b;
		if (model.aU && (!$author$project$Utils$maybeHasValue(model.t))) {
			var _new = A2(
				$author$project$Geometry$addPoints,
				event.ek,
				$author$project$Graph$getPosition(model.cC));
				...
				_Utils_update(
					model,
					{
						cC: A3(
							$author$project$Graph$updateGraphProperty,
							$author$project$Graph$setPosition,
							A2($author$project$GraphUtils$constrainBackgroundToCanvas, model, _new),
							model.cC),
						by: true
					}),
				cmd);
...
var $author$project$Main$animateHoveredPoint = F2(
	function (animations, newHover) {
		return _Utils_update(
			animations,
			{
				P: A3($mdgriffith$elm_animator$Animator$go, $mdgriffith$elm_animator$Animator$quickly, newHover, animations.P)
			});
	});
...
var $author$project$Main$checkToStartDrag = F2(
	function (event, _v0) {
		...
		var cmd = _v0.b;
		return _Utils_Tuple2(
			(!event.aC) ? _Utils_update(
				model,
				{by: false, aT: false, aU: true, cX: event.ex}) : model,
			cmd);
	});
			...
			if (!_v1.a) {
				if (!_v1.b.$) {
					if (_v1.c.$ === 1) {
						...
						var vertex = _v1.b.a;
						var _v3 = _v1.c;
						var edgeId = $elm$core$String$fromInt(model.q + 1);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									t: $elm$core$Maybe$Just(
										A8(
											...
											vertex,
											$elm$core$Maybe$Nothing,
											$author$project$Graph$Unfinished,
											vertex.ex,
											vertex.ex,
											_List_Nil))
								}),
					...
					if (_v1.c.$ === 1) {
						...
						var _v5 = _v1.b;
						var _v6 = _v1.c;
						var _v7 = A2($author$project$Main$getHoveringEdge, model, event);
						if (_v7.$ === 1) {
							return _Utils_Tuple2(model, cmd);
						} else {
							var _v8 = _v7.a;
							var edge = _v8.a;
							var point = _v8.b;
							var _v9 = _Utils_Tuple2(model.aj, edge.b1);
							if ((!_v9.a.$) && (!_v9.b.$)) {
...
var $author$project$Graph$addVertex = F3(
		...
		return _Utils_update(
			graph,
			{
				H: A3(
					$elm$core$Dict$insert,
					id,
					A4($author$project$Graph$Vertex, id, $elm$core$Maybe$Nothing, $author$project$Graph$LiftStation, position),
					graph.H)
			});
	});
var $author$project$Main$checkVertexCreation = F2(
	function (event, _v0) {
		var model = _v0.a;
		var cmd = _v0.b;
		var condition = model.by || ($author$project$Utils$maybeHasValue(model.t) || (!(!event.aC)));
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					cC: condition ? model.cC : A3(
						$author$project$Graph$updateGraphProperty,
						$author$project$Graph$addVertex(model.l),
						A3(
							$author$project$Geometry$canvasPointToBackgroundPoint,
							event.ex,
							$author$project$Graph$getPosition(model.cC),
...
var $author$project$Requests$handleGraph = function (result) {
	if (!result.$) {
		var graph = result.a;
		return $author$project$Messages$SetCurrentGraph(graph);
	} else {
		return $author$project$Messages$Noop;
	}
};
var $author$project$Requests$fetchGraph = F2(
	function (baseUrl, path) {
		return $elm$http$Http$get(
			{
				cH: A2($elm$http$Http$expectJson, $author$project$Requests$handleGraph, $author$project$Saves$graphDecoder),
				dv: _Utils_ap(baseUrl, path)
			});
	});
...
var $author$project$Graph$insertVertex = F2(
	function (vertex, graph) {
		return _Utils_update(
			graph,
			{
				H: A3($elm$core$Dict$insert, vertex.r, vertex, graph.H)
			});
	});
...
var $author$project$Graph$removeEdge = F2(
	function (edge, graph) {
		return _Utils_update(
			graph,
			{
				E: A2($elm$core$Dict$remove, edge.r, graph.E)
			});
	});
...
var $author$project$Graph$removeVertex = F2(
	function (vertex, graph) {
		return _Utils_update(
			graph,
			{
				E: A2(
					...
					F2(
						function (_v0, edge) {
							return (!_Utils_eq(edge.bS, vertex)) && (!_Utils_eq(
								edge.bv,
								$elm$core$Maybe$Just(vertex)));
						}),
					graph.E),
				H: A2($elm$core$Dict$remove, vertex.r, graph.H)
			});
	});
var $elm$core$String$append = _String_append;
var $author$project$Graph$edgeTypeToString = function (edgeType) {
	switch (edgeType.$) {
		case 0:
			var skiRunType = edgeType.a;
			return A2(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$int(edge.r)),
				_Utils_Tuple2(
				'title',
				A2($author$project$Saves$encodeMaybe, $elm$json$Json$Encode$string, edge.a2)),
				_Utils_Tuple2(
				'points',
				A2($elm$json$Json$Encode$list, $author$project$Saves$pointToJson, edge.ew)),
				_Utils_Tuple2(
				'start_id',
				$elm$json$Json$Encode$int(edge.bS.r)),
				_Utils_Tuple2(
				'end_id',
				A2(
				...
				$elm$json$Json$Encode$string(
					$author$project$Graph$edgeTypeToString(edge.b1)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$int(vertex.r)),
				_Utils_Tuple2(
				'title',
				A2($author$project$Saves$encodeMaybe, $elm$json$Json$Encode$string, vertex.a2)),
				_Utils_Tuple2(
				'position',
				$author$project$Saves$pointToJson(vertex.ex))
			]));
};
var $author$project$Saves$graphToJson = F2(
	function (indent, graph) {
		return A2(
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'background',
						$elm$json$Json$Encode$string(graph.bX)),
						_Utils_Tuple2(
						'zoom',
						$elm$json$Json$Encode$float(graph.cm)),
						_Utils_Tuple2(
						'position',
						$author$project$Saves$pointToJson(graph.bZ)),
						_Utils_Tuple2(
						'vertices',
						A2(
							$elm$json$Json$Encode$list,
							$author$project$Saves$vertexToJson,
							$elm$core$Dict$values(graph.H))),
						_Utils_Tuple2(
						'edges',
						A2(
							$elm$json$Json$Encode$list,
						...
						_Utils_Tuple2(
						'id',
						$elm$json$Json$Encode$string(graph.r))
					])));
	});
...
var $author$project$Saves$graphIndexEntryLocationEncoder = function (loc) {
...
var $author$project$Saves$graphIndexEntryEncoder = F2(
	function (withLocation, entry) {
		return $elm$json$Json$Encode$object(
			_Utils_ap(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'title',
						$elm$json$Json$Encode$string(entry.a2)),
						_Utils_Tuple2(
						'path',
						$elm$json$Json$Encode$string(entry.eu)),
						_Utils_Tuple2(
						'id',
						$elm$json$Json$Encode$string(entry.r))
					]),
				withLocation ? _List_fromArray(
					[
						_Utils_Tuple2(
						'location',
						$author$project$Saves$graphIndexEntryLocationEncoder(entry.ec))
					]) : _List_Nil));
	});
var $author$project$Saves$graphIndexEncoder = function (index) {
	return A2(
		$elm$json$Json$Encode$list,
		$author$project$Saves$graphIndexEntryEncoder(false),
...
var $author$project$Main$saveGraphAndIndex = function (model) {
	return $elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[
				$author$project$Main$saveGraph(model.cC),
				$author$project$Main$saveGraphIndex(model.ao)
			]));
};
...
var $author$project$Messages$UpdateMenu = function (a) {
	return {$: 18, a: a};
};
...
var $author$project$Menus$Menus$EdgeList = {$: 1};
var $author$project$Menus$Menus$VertexList = {$: 2};
var $author$project$Menus$Menus$update = F2(
	function (model, msg) {
		switch (msg.$) {
			case 0:
				var shown = msg.a;
					...
					_Utils_update(
						model,
						{
							dI: A2(
								$elm$core$Basics$max,
								0,
								A2($elm$core$Basics$min, 1, opacity))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
			...
			case 4:
				var edgeID = msg.a;
				var highlighted = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d4: A3($elm$core$Dict$insert, edgeID, highlighted, model.d4)
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				var vertexId = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d5: A3($elm$core$Dict$insert, vertexId, highlighted, model.d5)
						}),
					$elm$core$Platform$Cmd$none);
			case 6:
				return _Utils_Tuple2(
			...
			case 10:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bF: $author$project$Menus$Menus$VertexList}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bF: $author$project$Menus$Menus$EdgeList}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$updateMenu = F3(
	function (model, command, menuMsg) {
		return A3(
			...
			function (cmd) {
				return $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2($elm$core$Platform$Cmd$map, $author$project$Messages$UpdateMenu, cmd),
							command
						]));
			},
			A2($author$project$Menus$Menus$update, model.eh, menuMsg));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 10:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							v: A3($mdgriffith$elm_animator$Animator$update, newTime, $author$project$Main$animator, model.v)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var texture = msg.a;
						...
						_Utils_Tuple2(
							_Utils_update(
								model,
								{
									cC: A2(
										$elm$core$Maybe$map,
										$author$project$Graph$setBackground(model.J),
										model.cC),
									R: 0,
									dq: $elm$core$Maybe$Just(t)
								}),
							$author$project$Main$saveToLocalStorage(
								_Utils_Tuple2('background', model.J))));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 6:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							J: ((!bool) && $elm$core$String$isEmpty(model.J)) ? $author$project$Graph$getBackground(model.cC) : model.J,
							R: ((!bool) && $elm$core$String$isEmpty(model.J)) ? 1 : model.R,
							aT: bool
						}),
					$elm$core$Platform$Cmd$none);
			case 7:
			...
			case 8:
				...
				var height = _v2.b;
				return A3(
					$author$project$Main$adaptToNewDimensions,
					width,
					height,
					_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
			case 9:
				var delta = msg.a;
				var zoomBefore = $author$project$Graph$getZoom(model.cC);
				var w = A2(
					$elm$core$Maybe$withDefault,
					model.cl,
					A2(
				...
				var zoomAfter = A2(
					$elm$core$Basics$max,
					$author$project$Graph$getZoom(model.cC) - (delta / 1000),
					A2($elm$core$Basics$max, model.cl / w, model.b4 / h));
				return $author$project$Main$saveModel(
					_Utils_Tuple2(
						_Utils_update(
							model,
									...
									A2(
										...
										$author$project$Graph$setPosition(
											A2(
												...
												A2(
													$author$project$Geometry$subPoints,
													model.ae,
													A2(
														$author$project$Geometry$mulPoint,
														A3(
			...
			case 13:
				...
				if (uuid.$ === 1) {
					...
					var newIndex = A3(
						$elm$core$Dict$insert,
						string,
						A4($author$project$Graph$GraphIndexEntry, newGraph.a2, string, string, 0),
						model.ao);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								cC: $elm$core$Maybe$Just(newGraph),
								q: 0,
								ao: newIndex,
								l: 0
							}),
				...
				return _Utils_Tuple2(
					...
					function () {
						...
						if (_v4.$ === 1) {
							...
							var _v5 = indexEntry.ec;
							if (_v5 === 1) {
								return A2($author$project$Requests$fetchGraph, model.a8, indexEntry.eu);
							} else {
								return $author$project$Main$loadLocalGraph(indexEntry.r);
							}
						}
					}());
			case 17:
			...
			case 16:
				...
				if (maybeResult.$ === 1) {
					...
					if (!maybeResult.a.$) {
						var index = maybeResult.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									bM: A2($elm$core$Dict$union, model.bM, index)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 19:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{cC: newGraph}),
					$author$project$Main$saveGraph(newGraph));
			case 20:
				var vertex = msg.a;
				var title = msg.b;
				var newGraph = A3(
					$author$project$Graph$updateGraphProperty,
					$author$project$Graph$insertVertex,
					_Utils_update(
						vertex,
						{
							a2: $elm$core$Maybe$Just(title)
				...
				switch (menuMsg.$) {
					...
					case 11:
						...
						var newModel = _Utils_update(
							model,
							{
								cC: A3($author$project$Graph$updateGraphProperty, $author$project$Graph$removeEdge, edge, model.cC)
							});
						return A3($author$project$Main$updateMenu, newModel, $elm$core$Platform$Cmd$none, menuMsg);
					case 10:
						var vertex = menuMsg.a;
						var newModel = _Utils_update(
							model,
							{
								cC: A3($author$project$Graph$updateGraphProperty, $author$project$Graph$removeVertex, vertex, model.cC)
							});
						return A3($author$project$Main$updateMenu, newModel, $elm$core$Platform$Cmd$none, menuMsg);
					case 6:
						var edge = menuMsg.a;
					...
					case 7:
						...
						return A3(
							...
							menuMsg);
					default:
						return A3($author$project$Main$updateMenu, model, $elm$core$Platform$Cmd$none, menuMsg);
				}
		}
	});
var $author$project$Messages$MouseDown = function (a) {
	return {$: 2, a: a};
};
var $author$project$Messages$MouseLeave = {$: 5};
var $author$project$Messages$MouseMove = function (a) {
	return {$: 4, a: a};
};
var $author$project$Messages$MouseUp = function (a) {
	return {$: 3, a: a};
};
var $author$project$Messages$TextureLoaded = function (a) {
	return {$: 1, a: a};
};
var $author$project$Messages$ZoomChanged = function (a) {
	return {$: 9, a: a};
};
...
var $joakin$elm_canvas$Canvas$clear = F3(
	function (point, w, h) {
		return {
			...
			Y: A3($joakin$elm_canvas$Canvas$Internal$Canvas$DrawableClear, point, w, h)
		};
	});
				...
				switch (setting.$) {
					case 0:
						...
						return _Utils_update(
							r,
							{
								I: A2($elm$core$List$cons, cmd, r.I)
							});
					case 1:
						var cmds = setting.a;
						return _Utils_update(
							r,
							{
								I: A3($elm$core$List$foldl, $elm$core$List$cons, r.I, cmds)
							});
					case 3:
						var f = setting.a;
						return _Utils_update(
	...
	function (settings, p, t) {
		return A2(
			...
			settings,
			{
				I: _List_Nil,
				X: $joakin$elm_canvas$Canvas$Internal$Canvas$NotSpecified,
				Y: A2($joakin$elm_canvas$Canvas$Internal$Canvas$DrawableTexture, p, t)
			});
	});
var $author$project$Main$addBackground = F2(
			...
			return _Utils_ap(
				_List_fromArray(
					[
						...
						$joakin$elm_canvas$Canvas$clear,
						_Utils_Tuple2(0, 0),
						$joakin$elm_canvas$Canvas$Texture$dimensions(t).cl,
						$joakin$elm_canvas$Canvas$Texture$dimensions(t).b4),
						A3(
						$joakin$elm_canvas$Canvas$texture,
						_List_fromArray(
							[
								$joakin$elm_canvas$Canvas$Settings$Advanced$alpha(model.eh.dI)
							]),
						_Utils_Tuple2(0, 0),
						t)
					]),
...
var $author$project$Main$edgeLabel = F3(
	function (model, edge, point) {
		var position = A3(
			$author$project$Geometry$backgroundPointToCanvasPoint,
			point,
			$author$project$Graph$getPosition(model.cC),
			$author$project$Graph$getZoom(model.cC));
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('fixed -translate-x-1/2 -translate-y-full pointer-events-none'),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					$elm$core$String$fromFloat(position.g) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'left',
					$elm$core$String$fromFloat(position.f) + 'px')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('rounded-md px-2 text-secondary bg-primary bg-opacity-50 font-bold text-sm')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2(
								$elm$core$Maybe$withDefault,
								'edge-' + $elm$core$String$fromInt(edge.r),
								edge.a2))
						]))
				]));
	});
var $author$project$Menus$Menus$ConfirmDeleteEdge = function (a) {
	return {$: 6, a: a};
};
var $author$project$Menus$Menus$ConfirmDeleteVertex = function (a) {
	return {$: 5, a: a};
};
...
var $avh4$elm_color$Color$fromRgba = function (components) {
	return A4($avh4$elm_color$Color$RgbaSpace, components.ez, components.d1, components.dJ, components.dC);
};
var $avh4$elm_color$Color$red = A4($avh4$elm_color$Color$RgbaSpace, 204 / 255, 0 / 255, 0 / 255, 1.0);
var $author$project$Graph$skiRunColor = function (skiRunType) {
	switch (skiRunType) {
		case 0:
		...
		default:
			return $avh4$elm_color$Color$fromRgba(
				{dC: 1, dJ: 2 / 256, d1: 2 / 256, ez: 137 / 256});
	}
};
...
var $author$project$Main$edgeStyle = F2(
	function (edgeType, zoom) {
		return _Utils_ap(
			_List_fromArray(
				[
					$joakin$elm_canvas$Canvas$Settings$Line$lineWidth($author$project$Geometry$lineWidth / zoom),
						...
						if (skiRunType === 3) {
							return _List_fromArray(
								[
									...
									$author$project$Graph$skiRunColor(skiRunType)),
...
var $author$project$Main$pointToCanvasLibPoint = function (point) {
	return _Utils_Tuple2(point.f, point.g);
};
var $author$project$Main$edgeToPath = F2(
	function (model, edge) {
		return A2(
			$joakin$elm_canvas$Canvas$path,
			$author$project$Main$pointToCanvasLibPoint(edge.bS.ex),
			A2(
				$elm$core$List$map,
	...
	function (settings, entities) {
		return A2(
			...
			settings,
			{
				I: _List_Nil,
				X: $joakin$elm_canvas$Canvas$Internal$Canvas$NotSpecified,
				Y: $joakin$elm_canvas$Canvas$Internal$Canvas$DrawableGroup(entities)
			});
	});
var $author$project$Menus$Menus$isEdgeTitleEdited = F2(
	function (model, edge) {
		var _v0 = model.aG;
		if (!_v0.$) {
			var _v1 = _v0.a;
			var id = _v1.a;
			return _Utils_eq(id, edge.r);
		} else {
			return false;
		}
	});
		...
		if (!upcomingOccurring.b) {
			...
			if (!(!personality.dU)) {
				...
				var nextPersonality = getPersonality(
					lookup(next));
				var totalPortions = A2($elm$core$Basics$max, personality.dU + nextPersonality.dG, 1);
...
var $mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious = F5(
	function (lookup, getPersonality, _v0, unmodified, upcomingOccurring) {
		...
		var personality = getPersonality(
			lookup(event));
		var totalPrevPortions = A2($elm$core$Basics$max, prevPersonality.dU + personality.dG, 1);
...
var $mdgriffith$elm_animator$Internal$Timeline$createLookAhead = F4(
	function (fn, lookup, currentEvent, upcomingEvents) {
		if (!upcomingEvents.b) {
			...
			var upcomingOccurring = A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bW, currentEvent, unadjustedUpcoming, remain);
			return $elm$core$Maybe$Just(
				{
					dD: lookup(
					...
					dr: $mdgriffith$elm_animator$Internal$Time$inMilliseconds(
		...
		while (true) {
			...
			var lineStartEv = function () {
				if (maybePreviousEvent.$ === 1) {
					return A4($mdgriffith$elm_animator$Internal$Timeline$adjustTime, lookup, fn.bW, unadjustedStartEvent, lineRemain);
				} else {
					var prev = maybePreviousEvent.a;
					return A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bW, prev, unadjustedStartEvent, lineRemain);
				}
			}();
			if (A2(
				$mdgriffith$elm_animator$Internal$Time$thisBeforeThat,
				...
				if (A2(
					...
					if (!lineRemain.b) {
						return transition(
							A5(fn.ck, lookup, lineStartEv, now, $elm$core$Maybe$Nothing, state));
					} else {
						var unadjustedNext = lineRemain.a;
						var lineRemain2 = lineRemain.b;
						var next = A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bW, unadjustedStartEvent, unadjustedNext, lineRemain2);
						if (A2(
							$mdgriffith$elm_animator$Internal$Time$thisBeforeThat,
							now,
							$mdgriffith$elm_animator$Internal$Timeline$startTime(next))) {
							...
							if (A2(
								...
								if (!lineRemain2.b) {
									return transition(
										A5(fn.ck, lookup, next, now, $elm$core$Maybe$Nothing, state));
								} else {
									var unadjustedNext2 = lineRemain2.a;
									var lineRemain3 = lineRemain2.b;
									var next2 = A5($mdgriffith$elm_animator$Internal$Timeline$adjustTimeWithPrevious, lookup, fn.bW, unadjustedNext, unadjustedNext2, lineRemain3);
									if (A2(
										$mdgriffith$elm_animator$Internal$Time$thisBeforeThat,
										now,
...
var $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint = {f: 0, g: 0};
var $mdgriffith$elm_animator$Internal$Interpolate$createSpline = function (config) {
	var totalX = config.bv.f - config.bS.f;
	var startVelScale = 1 / (config.aZ.f / totalX);
	var startVelocity = (!config.bb.dV) ? {f: 0, g: 0} : (((!(config.aZ.f - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.f)) && (!(config.aZ.g - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.g))) ? {f: totalX * (config.bb.dV * 3), g: 0} : {f: (startVelScale * config.aZ.f) * (config.bb.dV * 3), g: (startVelScale * config.aZ.g) * (config.bb.dV * 3)});
	var endVelScale = 1 / (config.aJ.f / totalX);
	var endVelocity = (!config.a6.dH) ? {f: 0, g: 0} : (((!(config.aJ.f - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.f)) && (!(config.aJ.g - $mdgriffith$elm_animator$Internal$Interpolate$zeroPoint.g))) ? {f: totalX * (config.a6.dH * 3), g: 0} : {f: (endVelScale * config.aJ.f) * (config.a6.dH * 3), g: (endVelScale * config.aJ.g) * (config.a6.dH * 3)});
	return A4(
		$mdgriffith$elm_animator$Internal$Interpolate$Spline,
		config.bS,
		{f: config.bS.f + ((1 / 3) * startVelocity.f), g: config.bS.g + ((1 / 3) * startVelocity.g)},
		{f: config.bv.f + (((-1) / 3) * endVelocity.f), g: config.bv.g + (((-1) / 3) * endVelocity.g)},
		config.bv);
};
var $mdgriffith$elm_animator$Internal$Interpolate$findAtXOnSpline = F6(
	function (spline, desiredX, tolerance, jumpSize, t, depth) {
		...
		while (true) {
			...
			var point = function () {
				if (t <= 0.5) {
					var q3 = {f: p3.f + (t * (p4.f - p3.f)), g: p3.g + (t * (p4.g - p3.g))};
					var q2 = {f: p2.f + (t * (p3.f - p2.f)), g: p2.g + (t * (p3.g - p2.g))};
					var r2 = {f: q2.f + (t * (q3.f - q2.f)), g: q2.g + (t * (q3.g - q2.g))};
					var q1 = {f: p1.f + (t * (p2.f - p1.f)), g: p1.g + (t * (p2.g - p1.g))};
					var r1 = {f: q1.f + (t * (q2.f - q1.f)), g: q1.g + (t * (q2.g - q1.g))};
					return {f: r1.f + (t * (r2.f - r1.f)), g: r1.g + (t * (r2.g - r1.g))};
				} else {
					var q3 = {f: p4.f + ((1 - t) * (p3.f - p4.f)), g: p4.g + ((1 - t) * (p3.g - p4.g))};
					var q2 = {f: p3.f + ((1 - t) * (p2.f - p3.f)), g: p3.g + ((1 - t) * (p2.g - p3.g))};
					var r2 = {f: q3.f + ((1 - t) * (q2.f - q3.f)), g: q3.g + ((1 - t) * (q2.g - q3.g))};
					var q1 = {f: p2.f + ((1 - t) * (p1.f - p2.f)), g: p2.g + ((1 - t) * (p1.g - p2.g))};
					var r1 = {f: q2.f + ((1 - t) * (q1.f - q2.f)), g: q2.g + ((1 - t) * (q1.g - q2.g))};
					return {f: r2.f + ((1 - t) * (r1.f - r2.f)), g: r2.g + ((1 - t) * (r1.g - r2.g))};
				}
			}();
			if (depth === 10) {
				return {c0: point, cf: t};
			} else {
				if (($elm$core$Basics$abs(point.f - desiredX) < 1) && ($elm$core$Basics$abs(point.f - desiredX) >= 0)) {
					return {c0: point, cf: t};
				} else {
					if ((point.f - desiredX) > 0) {
...
var $mdgriffith$elm_animator$Internal$Interpolate$firstDerivativeOnSpline = F2(
	function (_v0, proportion) {
		...
		return {
			f: 3 * A3($mdgriffith$elm_animator$Internal$Interpolate$interpolateValue, wx1, wx2, proportion),
			g: 3 * A3($mdgriffith$elm_animator$Internal$Interpolate$interpolateValue, wy1, wy2, proportion)
		};
	});
var $mdgriffith$elm_animator$Internal$Interpolate$guessTime = F2(
	function (now, _v0) {
		...
		var three = _v0.c;
		var four = _v0.d;
		return (!(four.f - one.f)) ? 0.5 : ((now - one.f) / (four.f - one.f));
	});
var $mdgriffith$elm_animator$Internal$Interpolate$linearDefault = {dG: 0, dH: 0, dU: 0, dV: 0, eW: 0};
		...
		if (maybeLookAhead.$ === 1) {
			...
			if (_v3.$ === 1) {
				...
				return A4(
					...
					$mdgriffith$elm_animator$Internal$Time$millis(lookAhead.dr));
			} else {
				var period = _v3.b;
				var toX = _v3.c;
				if (lookAhead.eA) {
		...
		var curve = $mdgriffith$elm_animator$Internal$Interpolate$createSpline(
			{
				...
				bv: {
					f: targetTimeInMs,
					g: $ianmackenzie$elm_units$Pixels$inPixels(targetPosition)
				},
				aJ: {f: 1000, g: targetVelocity},
				bS: {
					f: startTimeInMs,
					g: $ianmackenzie$elm_units$Pixels$inPixels(state.ex)
				},
				aZ: {
					f: 1000,
					g: $ianmackenzie$elm_units$Pixels$inPixelsPerSecond(state.dw)
				}
			});
		var current = A6(
			...
			0);
		var firstDerivative = A2($mdgriffith$elm_animator$Internal$Interpolate$firstDerivativeOnSpline, curve, current.cf);
		return {
			ex: $ianmackenzie$elm_units$Pixels$pixels(current.c0.g),
			dw: $ianmackenzie$elm_units$Pixels$pixelsPerSecond(1000 * (firstDerivative.g / firstDerivative.f))
		};
	});
...
var $mdgriffith$elm_animator$Internal$Spring$step = F4(
	function (target, _v0, dtms, motion) {
		...
		var damping = _v0.a9;
		var mass = _v0.bg;
		var fspring = stiffness * (target - motion.ex);
		var fdamper = ((-1) * damping) * motion.dw;
		var dt = dtms / 1000;
		var a = (fspring + fdamper) / mass;
		var newVelocity = motion.dw + (a * dt);
		var newPos = motion.ex + (newVelocity * dt);
		return {ex: newPos, dw: newVelocity};
	});
...
var $mdgriffith$elm_animator$Internal$Interpolate$springInterpolation = F7(
	function (prevEndTime, _v0, target, targetTime, now, _v1, state) {
		...
		var _new = A4(
			...
			targetPos,
			{
				ex: $ianmackenzie$elm_units$Pixels$inPixels(state.ex),
				dw: $ianmackenzie$elm_units$Pixels$inPixelsPerSecond(state.dw)
			});
		return {
			ex: $ianmackenzie$elm_units$Pixels$pixels(_new.ex),
			dw: $ianmackenzie$elm_units$Pixels$pixelsPerSecond(_new.dw)
		};
	});
	...
	function (prevEndTime, maybePrev, target, targetTime, now, maybeLookAhead, state) {
		...
		var nothingHappened = function () {
			if (!target.$) {
				...
				return _Utils_eq(
					x,
					$ianmackenzie$elm_units$Pixels$inPixels(state.ex)) && (!$ianmackenzie$elm_units$Pixels$inPixelsPerSecond(state.dw));
			}
		}();
		if (nothingHappened) {
			return state;
...
var $mdgriffith$elm_animator$Internal$Interpolate$startMoving = function (movement) {
	return {
		...
		dw: $ianmackenzie$elm_units$Pixels$pixelsPerSecond(0)
	};
};
	...
	function (lookup, occurring, now, maybeLookAhead, state) {
		...
		if ($mdgriffith$elm_animator$Internal$Time$zeroDuration(dwellTime)) {
			...
			if (_v1.$ === 1) {
				var pos = _v1.b;
				return {
					ex: $ianmackenzie$elm_units$Pixels$pixels(pos),
					dw: $ianmackenzie$elm_units$Pixels$pixelsPerSecond(0)
				};
			} else {
				var period = _v1.b;
				...
				if (!period.$) {
					...
					return {
						ex: $ianmackenzie$elm_units$Pixels$pixels(
							toX(progress)),
						dw: A3($mdgriffith$elm_animator$Internal$Interpolate$derivativeOfEasing, toX, periodDuration, progress)
					};
				} else {
					var n = period.a;
					var periodDuration = period.b;
...
var $mdgriffith$elm_animator$Internal$Interpolate$moving = {bW: $mdgriffith$elm_animator$Internal$Interpolate$getPersonality, b0: $mdgriffith$elm_animator$Internal$Interpolate$dwellPeriod, b5: $mdgriffith$elm_animator$Internal$Interpolate$lerp, bS: $mdgriffith$elm_animator$Internal$Interpolate$startMoving, ck: $mdgriffith$elm_animator$Internal$Interpolate$visit};
	...
	function (builtInDefault, specified) {
		if (!specified.$) {
			...
			return {
				...
				eW: A2($mdgriffith$elm_animator$Internal$Interpolate$withDefault, builtInDefault.eW, partial.eW)
			};
		}
	});
var $mdgriffith$elm_animator$Internal$Interpolate$standardDefault = {dG: 0, dH: 0.8, dU: 0, dV: 0.4, eW: 0};
...
var $mdgriffith$elm_animator$Animator$move = F2(
	function (timeline, lookup) {
		return A2(
			...
			timeline,
			A2($elm$core$Basics$composeL, $mdgriffith$elm_animator$Internal$Interpolate$withStandardDefault, lookup)).ex;
	});
var $author$project$Main$secondaryColor = {dC: 1, dJ: 71 / 256, d1: 224 / 256, ez: 253 / 256};
...
var $author$project$Geometry$skiRunConnectionPointSize = 8;
		...
		return A2(
			...
			_Utils_ap(
				function () {
					if (_Utils_eq(
						model.eh.bF,
						$author$project$Menus$Menus$ConfirmDeleteVertex(edge.bS)) || (_Utils_eq(
						model.eh.bF,
						$author$project$Menus$Menus$ConfirmDeleteVertex(
							A2($elm$core$Maybe$withDefault, edge.bS, edge.bv))) || _Utils_eq(
						model.eh.bF,
						$author$project$Menus$Menus$ConfirmDeleteEdge(edge)))) {
						var multiplier = A2(
							...
							function (_v0) {
								return A2(
									...
									A2($mdgriffith$elm_animator$Animator$wrap, 0, 2));
							});
						return _List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$avh4$elm_color$Color$fromRgba(
											{
												dC: A2($elm$core$Basics$min, 1, 2 - multiplier),
												dJ: 0,
												d1: 0,
												ez: 1
											})),
										$joakin$elm_canvas$Canvas$Settings$Line$lineWidth(
										($author$project$Geometry$lineWidth * (1 + multiplier)) / $author$project$Graph$getZoom(model.cC))
									]),
								_List_fromArray(
									[
										A2($author$project$Main$edgeToPath, model, edge)
									]))
							]);
					} else {
						return _List_Nil;
					...
					_List_fromArray(
						[
							...
							_Utils_ap(
								...
								function () {
									var tempVertex = function (point) {
										return A2(
											$joakin$elm_canvas$Canvas$circle,
											$author$project$Main$pointToCanvasLibPoint(point),
											$author$project$Geometry$skiRunConnectionPointSize / $author$project$Graph$getZoom(model.cC));
									};
									var _v1 = _Utils_Tuple3(
										model.aj,
										edge.b1,
									...
									if (((!_v1.a.$) && (!_v1.b.$)) && (!_v1.c.$)) {
										...
										return _Utils_eq(edge.bS.r, -1) ? _List_fromArray(
											[
												tempVertex(edge.bS.ex)
											]) : _List_Nil;
									}
								}()))
						]),
					(A2($author$project$Menus$Menus$isEdgeTitleEdited, model.eh, edge) || A2(
						$elm$core$Maybe$withDefault,
						false,
						A2($elm$core$Dict$get, edge.r, model.eh.d4))) ? _List_fromArray(
						[
							A2(
							$joakin$elm_canvas$Canvas$shapes,
							_List_fromArray(
								[
									$joakin$elm_canvas$Canvas$Settings$Line$lineWidth(
									($author$project$Geometry$lineWidth * 0.5) / $author$project$Graph$getZoom(model.cC)),
									$joakin$elm_canvas$Canvas$Settings$Line$lineJoin(1),
									$joakin$elm_canvas$Canvas$Settings$stroke(
									$avh4$elm_color$Color$fromRgba($author$project$Main$secondaryColor)),
									$joakin$elm_canvas$Canvas$Settings$Line$lineDash(
									function () {
										var zoom = $author$project$Graph$getZoom(model.cC);
										var line = function (x) {
											return (x * 10) / zoom;
										};
										var gap = function (x) {
										...
										var dash = A2(
											...
											function (_v2) {
												return A2(
													...
													A2($mdgriffith$elm_animator$Animator$wrap, -1, 1));
											});
										return (dash > 0) ? ((dash > 0.999) ? _List_fromArray(
											[
												line(dash),
												gap(dash)
											]) : _List_fromArray(
											[
												...
												line(1),
												gap(1 - dash)
											])) : ((_Utils_cmp(dash, -0.999) < 0) ? _List_fromArray(
											[
												line(0),
												gap(1),
												line(1),
											...
											[
												line(
												1 - $elm$core$Basics$abs(dash)),
												gap(1),
												line(
												$elm$core$Basics$abs(dash)),
												gap(0)
											]));
									}())
								]),
...
var $author$project$Messages$SetMapFieldVisible = function (a) {
	return {$: 6, a: a};
};
var $perzanko$elm_loading$Loading$Sonar = 5;
var $author$project$Messages$TrySettingBackground = function (a) {
	return {$: 7, a: a};
};
...
var $perzanko$elm_loading$Loading$defaultConfig = {cA: '', dP: '#74b4c9', dk: 30, dm: 1};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.dR) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.en, record.dR, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {cz: charset, dS: finalDeclarations, cO: imports, cY: namespaces};
};
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aD: charsProcessed, aP: hash, ar: seed, aX: shift};
	});
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$finalize = function (data) {
	var acc = (!(!data.aP)) ? (data.ar ^ A2(
		...
		A2(
			...
			15,
			A2($rtfeldman$elm_css$ElmCssVendor$Murmur3$multiplyBy, $rtfeldman$elm_css$ElmCssVendor$Murmur3$c1, data.aP)))) : data.ar;
	var h0 = acc ^ data.aD;
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {aD: data.aD + 1, aP: res, ar: data.ar, aX: data.aX + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {cz: charset, dS: declarations, cO: imports, cY: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {cz: $elm$core$Maybe$Nothing, cO: _List_Nil, cY: _List_Nil, dl: snippets};
};
...
var $rtfeldman$elm_css$Css$auto = {dA: 0, a: 0, aM: 0, bB: 0, ea: 0, aQ: 0, ac: 0, Q: 0, aV: 0, M: 0, bU: 0, a0: 0, D: 0, U: 'auto'};
...
var $rtfeldman$elm_css$Css$Animations$keyframes = function (tuples) {
	return $elm$core$List$isEmpty(tuples) ? {bD: 0, b8: 0, U: 'none'} : {
		bD: 0,
		b8: 0,
...
var $perzanko$elm_loading$Loading$Bars$view = function (config) {
	...
	var childStyle = _List_fromArray(
		[
			$rtfeldman$elm_css$Css$width(
			$rtfeldman$elm_css$Css$px(config.dk / 3.5)),
			$rtfeldman$elm_css$Css$height(
			$rtfeldman$elm_css$Css$px(config.dk / 3.5)),
					...
					[
						...
						_List_fromArray(
							[
								...
								'height',
								$elm$core$String$fromFloat(config.dk / 3.5) + 'px'),
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$Animations$property,
								'height',
								$elm$core$String$fromFloat(config.dk) + 'px'),
								A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'translate3d(0,0,0)')
							])),
						_Utils_Tuple2(
						100,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Html$Styled$Attributes$class(config.cA)
			]),
		_List_fromArray(
			[
				A2(
...
var $rtfeldman$elm_css$Css$block = {i: 0, U: 'block'};
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$Animations$property,
								'transform',
								'translate3d(0,0,0) translateZ(0) translate(0,' + ($elm$core$String$fromFloat(config.dk / 3.5) + 'px)'))
							])),
						_Utils_Tuple2(
						100,
						_List_fromArray(
...
var $rtfeldman$elm_css$Css$absolute = {ex: 0, U: 'absolute'};
...
var $rtfeldman$elm_css$Css$num = function (val) {
	return {
		...
		a3: '',
		bq: 0,
		U: $elm$core$String$fromFloat(val)
	};
};
...
var $perzanko$elm_loading$Loading$Circle$view = function (config) {
	...
	var outerStyle = _List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$px(config.dk)),
			$rtfeldman$elm_css$Css$height(
			$rtfeldman$elm_css$Css$px(config.dk * 0.95)),
			$rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
			A2(
			$rtfeldman$elm_css$Css$margin2,
			$rtfeldman$elm_css$Css$px(0),
	...
	var childStyle = _List_fromArray(
		[
			$rtfeldman$elm_css$Css$width(
			$rtfeldman$elm_css$Css$px(config.dk - (2 * (config.dk * 0.17)))),
			$rtfeldman$elm_css$Css$height(
			$rtfeldman$elm_css$Css$px(config.dk - (2 * (config.dk * 0.17)))),
			$rtfeldman$elm_css$Css$borderRadius(
							...
							_List_fromArray(
								[
									...
									[
										...
										$rtfeldman$elm_css$Css$property,
										'border',
										$elm$core$String$fromFloat(config.dk * 0.17) + ('px ' + (config.dP + ' solid'))),
							...
							_List_fromArray(
								[
									...
									[
										...
										$rtfeldman$elm_css$Css$property,
										'border',
										$elm$core$String$fromFloat(config.dk * 0.17) + 'px transparent solid'),
										A2(
										$rtfeldman$elm_css$Css$property,
										'border-top',
										$elm$core$String$fromFloat(config.dk * 0.17) + ('px ' + (config.dP + ' solid'))),
...
var $perzanko$elm_loading$Loading$DoubleBounce$view = function (config) {
	...
	var innerStyle = _List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$property,
			'animation-duration',
			$elm$core$String$fromFloat(2 / config.dm) + 's'),
			A2($rtfeldman$elm_css$Css$property, 'animation-timing-function', 'ease-in-out'),
			A2($rtfeldman$elm_css$Css$property, 'animation-iteration-count', 'infinite')
		]);
	return A2(
							...
							_List_fromArray(
								[
									...
									[
										...
										$rtfeldman$elm_css$Css$property,
										'animation-delay',
										'-' + ($elm$core$String$fromFloat(1 / config.dm) + 's'))
									])
								])))
					]),
				_List_Nil)
...
var $rtfeldman$elm_css$Css$solid = {z: 0, as: 0, U: 'solid'};
		...
		[
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$pct(50)),
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$px(config.dk / 3)),
					$rtfeldman$elm_css$Css$height(
					$rtfeldman$elm_css$Css$px(config.dk / 3)),
					A2(
					$rtfeldman$elm_css$Css$property,
					'top',
					'calc(50% - ' + ($elm$core$String$fromFloat(config.dk / 6) + 'px)')),
					A2(
					$rtfeldman$elm_css$Css$property,
					'left',
					'calc(50% - ' + ($elm$core$String$fromFloat(config.dk / 6) + 'px)')),
					...
					$rtfeldman$elm_css$Css$property,
					'animation-duration',
					$elm$core$String$fromFloat(3 / config.dm) + 's'),
...
var $perzanko$elm_loading$Loading$Spinner$view = function (config) {
	...
	var calcAnimationDelay = function (x) {
		return (x === 1) ? '0s' : ($elm$core$String$fromFloat(-((1.1 - (x / 10)) / config.dm)) + 's');
	};
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
										...
										[
											...
											_List_fromArray(
												[
													...
													$rtfeldman$elm_css$Css$property,
													'animation-duration',
													$elm$core$String$fromFloat(1.2 / config.dm) + 's'),
													A2($rtfeldman$elm_css$Css$property, 'animation-iteration-count', 'infinite'),
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('max-w-0', !model.aT),
									_Utils_Tuple2('max-w-xs border-2 px-4 py-2', model.aT),
									_Utils_Tuple2('border-red-600', model.R === 2),
									_Utils_Tuple2('border-primary', model.R !== 2)
								])),
					...
					_List_fromArray(
						[
							...
							$author$project$Messages$SetMapFieldVisible(!model.aT))
						]),
					_List_fromArray(
...
var $author$project$Messages$SetActiveEdgeType = function (a) {
	return {$: 11, a: a};
};
...
var $author$project$Graph$skiRunColorCode = function (skiRunType) {
			...
			switch (edgeType.$) {
				case 0:
					...
					return $author$project$Icons$skiRunIcon(
						$author$project$Graph$skiRunColorCode(skiRunType));
				case 1:
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick(
					active ? $author$project$Messages$Noop : $author$project$Messages$SetActiveEdgeType(edgeType))
				]),
			_List_fromArray(
				[icon]));
	});
...
var $author$project$Model$MouseEvent = F3(
	function (position, movement, button) {
		return {aC: button, ek: movement, ex: position};
	});
			...
			function (offsetX, offsetY, movementX, movementY, button) {
				return msg(
					A3(
						...
						A2($author$project$Geometry$Point, offsetX, offsetY),
						A2($author$project$Geometry$Point, movementX, movementY),
						function () {
							switch (button) {
								case 0:
									return 0;
...
var $author$project$Messages$DownloadCurrentGraph = {$: 12};
			...
			[
				...
				_List_fromArray(
					[
						...
						'data:text/plain;charset=utf-8,' + A2(
							$elm$core$Maybe$withDefault,
							'',
							A2(
								$elm$core$Maybe$map,
								$author$project$Saves$graphToJson(2),
								model.cC))),
						$elm$html$Html$Attributes$download('graph.json'),
						$elm$html$Html$Events$onClick($author$project$Messages$DownloadCurrentGraph)
					]),
				_List_fromArray(
...
var $joakin$elm_canvas$Canvas$renderTextFill = F5(
	function (txt, x, y, maybeColor, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$fillText, txt.cg, x, y, txt.b6),
			function () {
				if (!maybeColor.$) {
					var color = maybeColor.a;
					return A2(
...
var $joakin$elm_canvas$Canvas$renderTextStroke = F5(
	function (txt, x, y, maybeColor, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$strokeText, txt.cg, x, y, txt.b6),
			function () {
				if (!maybeColor.$) {
					var color = maybeColor.a;
					return A2(
	...
	function (x, y, t, cmds) {
		return A2(
			...
			function () {
				if (!t.$) {
					var image = t.a;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, 0, 0, image.cl, image.b4, x, y, image.cl, image.b4, image.bC);
				} else {
					var sprite = t.a;
					var image = t.b;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, sprite.f, sprite.g, sprite.cl, sprite.b4, x, y, sprite.cl, sprite.b4, image.bC);
				}
			}(),
			cmds);
	});
				...
				function (tagName, width, height) {
					return (tagName === 'IMG') ? $elm$core$Maybe$Just(
						$joakin$elm_canvas$Canvas$Internal$Texture$TImage(
							{b4: height, bC: image, cl: width})) : $elm$core$Maybe$Nothing;
				}),
	...
	function (options, attrs, entities) {
		return A3(
			...
			A2(
				...
				A2(
					$elm$core$List$cons,
					$elm$html$Html$Attributes$height(options.b4),
					A2(
						$elm$core$List$cons,
						$elm$html$Html$Attributes$width(options.cl),
						attrs))),
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2('__canvas', $joakin$elm_canvas$Canvas$cnvs),
				A2($elm$core$List$map, $joakin$elm_canvas$Canvas$renderTextureSource, options.eP)));
	});
...
var $author$project$Main$vertexLabel = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'top',
					$elm$core$String$fromFloat(position.g + 15) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'left',
					$elm$core$String$fromFloat(position.f) + 'px')
				...
				[
					...
					_List_fromArray(
						[
							...
							A2(
								$elm$core$Maybe$withDefault,
								'vertex-' + $elm$core$String$fromInt(vertex.r),
								vertex.a2))
						]))
				]));
	});
...
var $author$project$Menus$Menus$isVertexTitleEdited = F2(
	function (model, vertex) {
		var _v0 = model.aH;
		if (!_v0.$) {
			var _v1 = _v0.a;
			var id = _v1.a;
			return _Utils_eq(id, vertex.r);
		} else {
			return false;
		}
	});
...
var $joakin$elm_canvas$Canvas$arc = F3(
	function (pos, radius, _v0) {
		var startAngle = _v0.eI;
		var endAngle = _v0.d_;
		var clockwise = _v0.dO;
		...
		return A2(
			...
			_List_fromArray(
				[
					A2(
					$joakin$elm_canvas$Canvas$path,
					$author$project$Main$pointToCanvasLibPoint(center),
					_List_fromArray(
						[
							$joakin$elm_canvas$Canvas$lineTo(
							_Utils_Tuple2(
								center.f + (radius * $elm$core$Basics$cos(startAngle)),
								center.g + (radius * $elm$core$Basics$sin(startAngle)))),
							$joakin$elm_canvas$Canvas$lineTo(
							_Utils_Tuple2(
								center.f + (radius * $elm$core$Basics$cos(endAngle)),
								center.g + (radius * $elm$core$Basics$sin(endAngle)))),
							$joakin$elm_canvas$Canvas$lineTo(
							$author$project$Main$pointToCanvasLibPoint(center))
						])),
					A3(
					...
					$author$project$Main$pointToCanvasLibPoint(center),
					radius,
					{dO: true, d_: endAngle, eI: startAngle})
				]));
	});
var $author$project$Graph$skiRunTypeFromString = function (skiRunType) {
	switch (skiRunType) {
		case 'easy':
			return 0;
		case 'medium':
...
var $author$project$Main$vertexAnimation = F4(
	function (baseRadius, baseMultiplier, hoverMultiplier, state) {
		return $mdgriffith$elm_animator$Animator$at(
			function () {
				if (state.$ === 1) {
					return baseMultiplier * baseRadius;
				} else {
					return hoverMultiplier * baseRadius;
				}
			}());
	});
var $mdgriffith$elm_animator$Internal$Timeline$linearDefault = {dG: 0, dH: 0, dU: 0, dV: 0, eW: 0};
...
var $mdgriffith$elm_animator$Internal$Timeline$previous = function (timeline) {
	...
	return A3(
		...
		$elm$core$Basics$identity,
		{
			...
			b5: $mdgriffith$elm_animator$Internal$Timeline$getPrev,
			bS: function (_v2) {
				return details.cQ;
			},
			ck: F5(
...
var $author$project$Main$vertexExpansionCondition = F2(
	function (model, vertex) {
		return _Utils_eq(
			$mdgriffith$elm_animator$Animator$current(model.v.P),
			$elm$core$Maybe$Just(vertex)) || (_Utils_eq(
			$mdgriffith$elm_animator$Animator$arrived(model.v.P),
			$elm$core$Maybe$Just(vertex)) || _Utils_eq(
			$mdgriffith$elm_animator$Animator$previous(model.v.P),
			$elm$core$Maybe$Just(vertex)));
	});
var $author$project$Main$vertexPointSize = F4(
	function (model, vertex, baseMultiplier, hoverMultiplier) {
		var baseRadius = function () {
			var _v0 = vertex.cj;
			if (!_v0.$) {
				return $author$project$Geometry$liftStationPointSize;
			} else {
				return $author$project$Geometry$skiRunConnectionPointSize;
			}
		}();
		return A2(
			$elm$core$Basics$max,
			0,
			A2($author$project$Main$vertexExpansionCondition, model, vertex) ? A2(
				$mdgriffith$elm_animator$Animator$move,
				model.v.P,
				A3($author$project$Main$vertexAnimation, baseRadius, baseMultiplier, hoverMultiplier)) : (A2($author$project$Main$vertexEdgeDrawingCondition, model, vertex) ? (hoverMultiplier * baseRadius) : (baseMultiplier * baseRadius))) / $author$project$Graph$getZoom(model.cC);
	});
...
var $author$project$Main$vertexView = F2(
	function (model, vertex) {
		return A2(
			...
			_Utils_ap(
				function () {
					if (A2($author$project$Menus$Menus$isVertexTitleEdited, model.eh, vertex) || A2(
						$elm$core$Maybe$withDefault,
						false,
						A2($elm$core$Dict$get, vertex.r, model.eh.d5))) {
						var multiplier = A2(
							$mdgriffith$elm_animator$Animator$move,
							model.v.bA,
							function (_v0) {
							...
							[
								...
								_List_fromArray(
									[
										...
										$avh4$elm_color$Color$fromRgba(
											_Utils_update(
												$author$project$Main$secondaryColor,
												{
													dC: A2($elm$core$Basics$min, 1, 2 - multiplier)
												})))
									]),
								_List_fromArray(
									[
										A2(
										$joakin$elm_canvas$Canvas$circle,
										_Utils_Tuple2(vertex.ex.f, vertex.ex.g),
										A4($author$project$Main$vertexPointSize, model, vertex, 1 + multiplier, 1.5 + multiplier))
									]))
							]);
					} else {
						return _List_Nil;
				...
				_Utils_ap(
					function () {
						if (_Utils_eq(
							model.eh.bF,
							$author$project$Menus$Menus$ConfirmDeleteVertex(vertex))) {
							var multiplier = A2(
								$mdgriffith$elm_animator$Animator$move,
								model.v.ba,
								function (_v1) {
						...
						[
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											$joakin$elm_canvas$Canvas$circle,
											_Utils_Tuple2(vertex.ex.f, vertex.ex.g),
											A4($author$project$Main$vertexPointSize, model, vertex, 1, 1.5))
										]));
							} else {
								var percentages = _v2.a;
								return A2(
									$joakin$elm_canvas$Canvas$group,
									_List_Nil,
									A3(
										...
										F2(
											function (_v3, _v4) {
												var skiRunType = _v3.a;
												var percentage = _v3.b;
												var renderables = _v4.a;
												var start = _v4.b;
												return _Utils_Tuple2(
													_Utils_ap(
														renderables,
														_List_fromArray(
															[
																...
																$author$project$Graph$skiRunColor(
																	$author$project$Graph$skiRunTypeFromString(skiRunType)),
																vertex.ex,
																A4($author$project$Main$vertexPointSize, model, vertex, 1, 1.5),
																$elm$core$Basics$degrees(
																	360 * A2($elm$core$Basics$min, 1, start)),
																$elm$core$Basics$degrees(
																	360 * A2($elm$core$Basics$min, 1, start + percentage)))
															])),
													start + percentage);
											}),
										_Utils_Tuple2(_List_Nil, 0),
										$elm$core$Dict$toList(percentages)).a);
							}
						}(),
							A2(
							$joakin$elm_canvas$Canvas$shapes,
							...
							_List_fromArray(
								[
									...
									$joakin$elm_canvas$Canvas$circle,
									_Utils_Tuple2(vertex.ex.f, vertex.ex.g),
									A4($author$project$Main$vertexPointSize, model, vertex, 0, 1))
								]))
						]))));
	});
var $author$project$Main$canvasView = function (model) {
	return _Utils_ap(
		_List_fromArray(
			[
				A3(
				...
				{
					b4: $elm$core$Basics$ceiling(model.b4),
					eP: _List_fromArray(
						[
							A2($joakin$elm_canvas$Canvas$Texture$loadFromImageUrl, model.J, $author$project$Messages$TextureLoaded)
						]),
					cl: $elm$core$Basics$ceiling(model.cl)
				},
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$on,
						'mousedown',
						$author$project$Main$mouseDecoder($author$project$Messages$MouseDown)),
						A2(
						$elm$html$Html$Events$on,
						'mouseup',
						$author$project$Main$mouseDecoder($author$project$Messages$MouseUp)),
						A2(
						$elm$html$Html$Events$on,
						'mouseleave',
						$author$project$Main$mouseDecoder(
							function (_v0) {
								return $author$project$Messages$MouseLeave;
							})),
						A2(
						$elm$html$Html$Events$on,
						'mousemove',
						$author$project$Main$mouseDecoder($author$project$Messages$MouseMove)),
						A2(
						$elm$html$Html$Events$on,
						'wheel',
						$author$project$Main$scrollDecoder($author$project$Messages$ZoomChanged))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								function () {
									var zoom = $author$project$Graph$getZoom(model.cC);
									var pos = $author$project$Graph$getPosition(model.cC);
									return _List_fromArray(
										[
											A2($joakin$elm_canvas$Canvas$Settings$Advanced$translate, pos.f, pos.g),
				...
				$author$project$Main$modeSelectionButtons(model.aj),
				$author$project$Main$saveMapButtons(model)
			]),
		function () {
			var _v2 = _Utils_Tuple2(
				A2(
					$author$project$Main$getEdgeOnPosition,
					model,
					A3(
						$author$project$Geometry$canvasPointToBackgroundPoint,
						model.ae,
						$author$project$Graph$getPosition(model.cC),
						$author$project$Graph$getZoom(model.cC))),
				A2($author$project$Main$getVertexOnPosition, model, model.ae));
			if (!_v2.b.$) {
				var vertex = _v2.b.a;
				return _List_fromArray(
					[
						A2($author$project$Main$vertexLabel, model, vertex)
					]);
			} else {
				if (!_v2.a.$) {
					var _v3 = _v2.a.a;
					...
					return _List_fromArray(
						[
							A3($author$project$Main$edgeLabel, model, edge, point)
						]);
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Saves$graphIndexEntryFromString = function (jsonString) {
	var _v0 = A2(
		$elm$json$Json$Decode$decodeString,
		$author$project$Saves$graphIndexEntryDecoder($elm$core$Maybe$Nothing),
		jsonString);
	if (!_v0.$) {
		var value = _v0.a;
		return $elm$core$Maybe$Just(value);
...
var $author$project$Saves$graphIndexEntryToString = F2(
	function (indentation, entry) {
		return A2(
			$elm$json$Json$Encode$encode,
			indentation,
			A2($author$project$Saves$graphIndexEntryEncoder, true, entry));
	});
var $elm$html$Html$option = _VirtualDom_node('option');
var $elm$html$Html$select = _VirtualDom_node('select');
var $author$project$Main$graphSelectionView = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Create a new graph')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-center my-8')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('or select one of existing graphs:')
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('transition-all border-2 border-primary rounded-md min-w-[15rem]'),
									A2(
									$elm$html$Html$Events$on,
									'change',
									A2(
										$elm$json$Json$Decode$map,
										function (s) {
											return $author$project$Messages$SelectGraphFromIndex(
												$author$project$Saves$graphIndexEntryFromString(s));
										},
										A2(
											$elm$json$Json$Decode$at,
											_List_fromArray(
							...
							A2(
								...
								A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('No graph selected...')
										])),
								A2(
									$elm$core$List$map,
									function (e) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$value(
													A2($author$project$Saves$graphIndexEntryToString, 0, e))
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(
									...
									A2(
										$elm$core$List$append,
										$elm$core$Dict$values(model.ao),
										$elm$core$Dict$values(model.bM))))),
							function () {
							var disabled = !$author$project$Utils$maybeHasValue(model.bR);
							return A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('transition-colors rounded-md font-bold uppercase ml-2 px-4 py-2'),
										$elm$html$Html$Attributes$classList(
										_List_fromArray(
											[
												_Utils_Tuple2('bg-gray-200 text-gray-400', disabled),
												_Utils_Tuple2('bg-primary text-secondary hover:bg-secondary hover:text-primary shadow-md', !disabled)
											])),
										$elm$html$Html$Events$onClick(
										disabled ? $author$project$Messages$Noop : $author$project$Messages$LoadExistingGraph),
...
var $author$project$Messages$menuMsgToMsg = function (menuMsg) {
	return $author$project$Messages$UpdateMenu(menuMsg);
};
var $author$project$Menus$Menus$LeaveGraph = {$: 2};
var $author$project$Menus$Menus$SetMenuShown = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Menus$Menus$DeleteEdge = function (a) {
	return {$: 11, a: a};
};
var $author$project$Menus$Menus$SetMainMenuView = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Menus$Menus$confirmDeleteView = F4(
	function (onCancel, onConfirm, vertices, edges) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('col-span-2 flex w-full items-center transition-colors hover:bg-blue-500 px-2 py-3 mb-2 rounded-md font-light'),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('font-bold text-lg text-secondary')
										]),
									_List_fromArray(
										[
					...
					_Utils_ap(
						function () {
							var nv = $elm$core$List$length(vertices);
							var ne = $elm$core$List$length(edges);
							var _v0 = _Utils_Tuple2(vertices, edges);
							if (!_v0.a.b) {
								if (!_v0.b.b) {
									return _List_Nil;
								} else {
									return _List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('col-span-2 font-light text-white')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(
													'You are about to delete ' + ($elm$core$String$fromInt(ne) + ((ne > 1) ? ' edges:' : ' edge:')))
												])),
											A2(
											$elm$html$Html$ul,
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('col-span-2 font-bold pl-2')
												]),
											A2(
												$elm$core$List$map,
												function (e) {
													return A2(
														...
														_List_fromArray(
															[
																...
																A2(
																	$elm$core$Maybe$withDefault,
																	'edge-' + $elm$core$String$fromInt(e.r),
																	e.a2))
															]));
												},
												edges))
									...
									return _List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													'You are about to delete ' + ($elm$core$String$fromInt(nv) + ((nv > 1) ? ' vertices:' : ' vertex:')))
												])),
											A2(
											$elm$html$Html$ul,
											_List_fromArray(
													...
													return A2(
														...
														_List_fromArray(
															[
																...
																A2(
																	$elm$core$Maybe$withDefault,
																	'vertex-' + $elm$core$String$fromInt(v.r),
																	v.a2))
															]));
												},
												vertices))
									...
									return _List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													'This will also delete the following ' + ($elm$core$String$fromInt(ne) + (' connected' + ((ne > 1) ? ' edges:' : ' edge:'))))
												])),
											A2(
											$elm$html$Html$ul,
											_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('rounded-md border-secondary border transition-colors text-secondary hover:bg-secondary hover:text-primary'),
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('rounded-md border transition-colors bg-secondary text-primary hover:bg-primary hover:text-secondary border hover:border-secondary'),
										$elm$html$Html$Events$onClick(onConfirm)
									]),
								_List_fromArray(
									[
...
var $author$project$Menus$Menus$confirmDeleteEdgeView = function (edge) {
	return A4(
		$author$project$Menus$Menus$confirmDeleteView,
		$author$project$Menus$Menus$SetMainMenuView($author$project$Menus$Menus$EdgeList),
		$author$project$Menus$Menus$DeleteEdge(edge),
		_List_Nil,
		_List_fromArray(
			[edge]));
};
var $author$project$Menus$Menus$DeleteVertex = function (a) {
	return {$: 10, a: a};
};
var $author$project$Graph$findConnectedEdges = F2(
	function (vertex, graph) {
		return A2(
			$elm$core$List$filter,
			function (edge) {
				return _Utils_eq(edge.bS.r, vertex.r) || A2(
					$elm$core$Maybe$withDefault,
					false,
					A2(
						$elm$core$Maybe$map,
						function (v) {
							return _Utils_eq(v.r, vertex.r);
						},
						edge.bv));
			},
			$elm$core$Dict$values(graph.E));
	});
var $author$project$Menus$Menus$confirmDeleteVertexView = F2(
	function (vertex, graph) {
		return A4(
			$author$project$Menus$Menus$confirmDeleteView,
			$author$project$Menus$Menus$SetMainMenuView($author$project$Menus$Menus$VertexList),
			$author$project$Menus$Menus$DeleteVertex(vertex),
			_List_fromArray(
				[vertex]),
			A2($author$project$Graph$findConnectedEdges, vertex, graph));
	});
var $author$project$Menus$Menus$SetBackgroundOpacity = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Menus$Menus$defaultView = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('flex justify-between h-12 w-full items-center transition-colors hover:bg-blue-500 px-2 rounded-md font-light'),
					$elm$html$Html$Events$onClick(
					$author$project$Menus$Menus$SetMainMenuView($author$project$Menus$Menus$EdgeList))
				]),
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('h-12 flex flex-col justify-center px-2')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('font-light flex justify-between')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Background opacity')
								])),
							A2(
							$elm$html$Html$span,
							_List_Nil,
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(
										$elm$core$Basics$round(100 * model.dI)) + '%')
								]))
						])),
					A2(
					$elm$html$Html$input,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('w-full block mt-1'),
							$elm$html$Html$Attributes$max('1'),
							$elm$html$Html$Attributes$min('0'),
							$elm$html$Html$Attributes$step('0.01'),
							$elm$html$Html$Attributes$value(
							$elm$core$String$fromFloat(model.dI)),
							$elm$html$Html$Events$onInput(
							A2(
								$elm$core$Basics$composeL,
								A2(
									$elm$core$Basics$composeL,
									$author$project$Menus$Menus$SetBackgroundOpacity,
...
var $author$project$Menus$Menus$SetEdgeHighlighted = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $author$project$Menus$Menus$SetEdgeTitle = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
var $author$project$Menus$Menus$SetEditingEdgeTitle = function (a) {
	return {$: 8, a: a};
};
var $author$project$Icons$detail = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			$elm$svg$Svg$Attributes$class('h-5 w-5'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$d('M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z')
				]),
			_List_Nil)
		]));
var $elm$html$Html$h3 = _VirtualDom_node('h3');
var $author$project$Icons$highlight = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			$elm$svg$Svg$Attributes$class('h-5 w-5'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$d('M10 12a2 2 0 100-4 2 2 0 000 4z')
				]),
			_List_Nil),
			A2(
			$elm$svg$Svg$path,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$fillRule('evenodd'),
					$elm$svg$Svg$Attributes$d('M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z'),
					$elm$svg$Svg$Attributes$clipRule('evenodd')
				]),
			_List_Nil)
		]));
...
var $author$project$Icons$remove = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			$elm$svg$Svg$Attributes$class('h-5 w-5'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$fillRule('evenodd'),
					$elm$svg$Svg$Attributes$d('M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z'),
					$elm$svg$Svg$Attributes$clipRule('evenodd')
				]),
			_List_Nil)
		]));
var $author$project$Menus$Menus$edgeInListView = F2(
	function (model, edge) {
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('grid grid-cols-12 gap-2')
				]),
			_Utils_ap(
				function () {
					var _v0 = edge.b1;
					if (!_v0.$) {
						var skiRunType = _v0.a;
						return _List_fromArray(
							[
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('bg-white rounded-full self-center h-5 w-5 p-1')
									]),
								_List_fromArray(
									[
										$author$project$Icons$skiRunIcon(
										$author$project$Graph$skiRunColorCode(skiRunType))
									]))
							]);
					} else {
				...
				_Utils_ap(
					function () {
						var withoutIcon = _Utils_eq(edge.b1, $author$project$Graph$Lift) || _Utils_eq(edge.b1, $author$project$Graph$Unfinished);
						var title = _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('col-span-8 transition-all border border-primary rounded-md pl-1 hover:border-blue-500'),
										$elm$html$Html$Attributes$classList(
										_List_fromArray(
											[
												_Utils_Tuple2('col-start-2', withoutIcon)
											])),
										$elm$html$Html$Events$onClick(
										$author$project$Menus$Menus$SetEditingEdgeTitle(
											$elm$core$Maybe$Just(
												_Utils_Tuple2(
													edge.r,
													A2(
						...
						if (!_v1.$) {
							...
							var id = _v2.a;
							var newTitle = _v2.b;
							return _Utils_eq(id, edge.r) ? _List_fromArray(
								[
									A2(
									$elm$html$Html$input,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('col-span-8 pl-1 text-black rounded-md bg-white w-full'),
											$elm$html$Html$Attributes$value(newTitle),
											$elm$html$Html$Attributes$classList(
											_List_fromArray(
												[
													_Utils_Tuple2('col-start-2', withoutIcon)
											...
											$elm$html$Html$Events$onInput(
											function (t) {
												return $author$project$Menus$Menus$SetEditingEdgeTitle(
													$elm$core$Maybe$Just(
														_Utils_Tuple2(edge.r, t)));
											}),
											$elm$html$Html$Events$onBlur(
											A2($author$project$Menus$Menus$SetEdgeTitle, edge, newTitle)),
											A2(
											$elm$html$Html$Events$on,
											'keyup',
											A2(
												...
												function (keyCode) {
													return (keyCode === 13) ? $elm$json$Json$Decode$succeed(
														A2($author$project$Menus$Menus$SetEdgeTitle, edge, newTitle)) : $elm$json$Json$Decode$fail('Not Enter.');
												},
					...
					_List_fromArray(
						[
							...
							var highlighted = A2(
								$elm$core$Maybe$withDefault,
								false,
								A2($elm$core$Dict$get, edge.r, model.d4));
							return A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('transition-colors hover:text-white'),
										$elm$html$Html$Attributes$classList(
										_List_fromArray(
											[
												_Utils_Tuple2('text-blue-200', !highlighted),
												_Utils_Tuple2('text-secondary', highlighted)
											])),
										$elm$html$Html$Events$onClick(
										A2($author$project$Menus$Menus$SetEdgeHighlighted, edge.r, !highlighted))
									]),
								_List_fromArray(
									[$author$project$Icons$highlight]));
						}(),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('transition-colors hover:text-red-600'),
									$elm$html$Html$Events$onClick(
									$author$project$Menus$Menus$SetMainMenuView(
										$author$project$Menus$Menus$ConfirmDeleteEdge(edge)))
								]),
							_List_fromArray(
								[$author$project$Icons$remove])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('transition-colors hover:text-secondary')
								]),
							_List_fromArray(
								[$author$project$Icons$detail]))
						]))));
	});
...
var $author$project$Graph$titleComparator = F2(
	function (a, b) {
		var _v0 = _Utils_Tuple2(a.a2, b.a2);
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				var _v1 = _v0.a;
				var _v2 = _v0.b;
			...
			if (_v0.b.$ === 1) {
				...
				var titleA = _v0.a.a;
				var titleB = _v0.b.a;
				return A2($elm$core$Basics$compare, titleA, titleB);
			}
		}
	});
var $author$project$Menus$Menus$edgesListView = F2(
	function (model, edges) {
		var _v0 = A2(
			$elm$core$List$partition,
			function (edge) {
				return _Utils_eq(edge.b1, $author$project$Graph$Lift);
			},
			edges);
		var lifts = _v0.a;
		var runs = _v0.b;
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex w-full items-center transition-colors hover:bg-blue-500 px-2 py-3 mb-2 rounded-md font-light'),
						$elm$html$Html$Events$onClick(
						$author$project$Menus$Menus$SetMainMenuView($author$project$Menus$Menus$Default))
					]),
				_List_fromArray(
					[
						$author$project$Icons$chevronLeft,
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('overflow-y-auto pl-4')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('font-bold text-secondary')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Ski lifts')
									])),
								A2(
								$elm$html$Html$ul,
								_List_Nil,
								A2(
									$elm$core$List$map,
									$author$project$Menus$Menus$edgeInListView(model),
									A2($elm$core$List$sortWith, $author$project$Graph$titleComparator, lifts)))
							])),
						A2(
						$elm$html$Html$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$List$map,
									$author$project$Menus$Menus$edgeInListView(model),
									A2($elm$core$List$sortWith, $author$project$Graph$titleComparator, runs)))
							]))
					]))
			]);
	});
var $author$project$Menus$Menus$SetEditingVertexTitle = function (a) {
	return {$: 9, a: a};
};
var $author$project$Menus$Menus$SetVertexHighlighted = F2(
	function (a, b) {
		return {$: 5, a: a, b: b};
	});
var $author$project$Menus$Menus$SetVertexTitle = F2(
	function (a, b) {
		return {$: 7, a: a, b: b};
	});
var $author$project$Menus$Menus$vertexInListView = F2(
	function (model, vertex) {
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				...
				function () {
					var title = _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('col-span-9 transition-all border border-primary rounded-md pl-1 hover:border-blue-500'),
									$elm$html$Html$Events$onClick(
									$author$project$Menus$Menus$SetEditingVertexTitle(
										$elm$core$Maybe$Just(
											_Utils_Tuple2(
												vertex.r,
												A2(
					...
					if (!_v0.$) {
						...
						var id = _v1.a;
						var newTitle = _v1.b;
						return _Utils_eq(id, vertex.r) ? _List_fromArray(
							[
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('col-span-9 pl-1 text-black rounded-md bg-white w-full'),
										$elm$html$Html$Attributes$value(newTitle),
										$elm$html$Html$Events$onInput(
										function (t) {
											return $author$project$Menus$Menus$SetEditingVertexTitle(
												$elm$core$Maybe$Just(
													_Utils_Tuple2(vertex.r, t)));
										}),
										$elm$html$Html$Events$onBlur(
										A2($author$project$Menus$Menus$SetVertexTitle, vertex, newTitle)),
										A2(
										$elm$html$Html$Events$on,
										'keyup',
										A2(
											...
											function (keyCode) {
												return (keyCode === 13) ? $elm$json$Json$Decode$succeed(
													A2($author$project$Menus$Menus$SetVertexTitle, vertex, newTitle)) : $elm$json$Json$Decode$fail('Not Enter.');
											},
											$elm$html$Html$Events$keyCode))
									]),
								_List_Nil)
				...
				_List_fromArray(
					[
						...
						var highlighted = A2(
							$elm$core$Maybe$withDefault,
							false,
							A2($elm$core$Dict$get, vertex.r, model.d5));
						return A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onClick(
									A2($author$project$Menus$Menus$SetVertexHighlighted, vertex.r, !highlighted))
								]),
							_List_fromArray(
								[$author$project$Icons$highlight]));
					}(),
...
var $author$project$Menus$Menus$verticesListView = F2(
	function (model, vertices) {
		var _v0 = A2(
			$elm$core$List$partition,
			function (vertex) {
				return _Utils_eq(vertex.cj, $author$project$Graph$LiftStation);
			},
			vertices);
		var stations = _v0.a;
		var crossroads = _v0.b;
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$button,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Lift stations')
									])),
								A2(
								$elm$html$Html$ul,
								_List_Nil,
								A2(
									$elm$core$List$map,
									$author$project$Menus$Menus$vertexInListView(model),
									A2($elm$core$List$sortWith, $author$project$Graph$titleComparator, stations)))
							])),
						A2(
						$elm$html$Html$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Ski run X-ings')
									])),
								A2(
								$elm$html$Html$ul,
								_List_Nil,
								A2(
									$elm$core$List$map,
									$author$project$Menus$Menus$vertexInListView(model),
									A2($elm$core$List$sortWith, $author$project$Graph$titleComparator, crossroads)))
							]))
					]))
			]);
	});
var $author$project$Menus$Menus$menuView = F2(
	function (model, graph) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('w-full h-full flex flex-col pt-2')
				]),
			function () {
				var _v0 = model.bF;
				switch (_v0.$) {
					case 0:
						return $author$project$Menus$Menus$defaultView(model);
					case 1:
						return A2(
							$author$project$Menus$Menus$edgesListView,
							model,
							$elm$core$Dict$values(graph.E));
					case 2:
						return A2(
							$author$project$Menus$Menus$verticesListView,
							model,
							$elm$core$Dict$values(graph.H));
					case 3:
						var edge = _v0.a;
					...
					case 5:
						var vertex = _v0.a;
						return A2($author$project$Menus$Menus$confirmDeleteVertexView, vertex, graph);
					default:
						var edge = _v0.a;
						return $author$project$Menus$Menus$confirmDeleteEdgeView(edge);
				}
			}());
	});
var $author$project$Menus$Menus$menuPane = F2(
	function (model, graph) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('fixed top-0 bottom-0 w-96 w-full transition-all bg-primary shadow-md z-20'),
					$elm$html$Html$Attributes$classList(
					_List_fromArray(
						[
							_Utils_Tuple2('left-0', model.eH),
							_Utils_Tuple2('-left-96', !model.eH)
						]))
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('bg-primary text-secondary p-4 rounded-br-md shadow-md w-max absolute top-0 left-0')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-xl font-bold inline-block w-96 pr-8')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(graph.a2)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onClick(
									$author$project$Menus$Menus$SetMenuShown(!model.eH))
								]),
							_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('w-full h-full pt-16 pb-16 px-2 text-white')
						]),
					_List_fromArray(
						[
							A2($author$project$Menus$Menus$menuView, model, graph)
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('flex shadow-inner absolute bottom-0 left-0 right-0')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('px-6 py-3 shadow-inner text-secondary font-bold transition-colors hover:bg-secondary hover:text-primary'),
									$elm$html$Html$Events$onClick($author$project$Menus$Menus$LeaveGraph)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Leave graph')
								]))
						]))
				]));
	});
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('h-screen w-screen overflow-hidden relative')
			]),
		function () {
			var _v0 = model.cC;
			if (_v0.$ === 1) {
				return $author$project$Main$graphSelectionView(model);
			} else {
				var graph = _v0.a;
				return A2(
					$elm$core$List$cons,
					A2(
						$elm$html$Html$map,
						$author$project$Messages$menuMsgToMsg,
						A2($author$project$Menus$Menus$menuPane, model.eh, graph)),
					$author$project$Main$canvasView(model));
			}
		}());
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{d8: $author$project$Main$init, eM: $author$project$Main$subscriptions, eS: $author$project$Main$update, eV: $author$project$Main$view});
											...
											return A2(
												...
												function (graphJson) {
													return A2(
														...
														function (baseUrl) {
															return $elm$json$Json$Decode$succeed(
																{a8: baseUrl, cK: graphJson, b4: height, ao: localGraphIndex, dc: savedBackground, eF: selectedGraphID, cl: width});
														},
